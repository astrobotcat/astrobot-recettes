"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveProviderAuthEnvVarCandidates;exports.i = omitEnvKeysCaseInsensitive;exports.n = listKnownProviderAuthEnvVarNames;exports.o = resolveProviderIdForAuth;exports.r = listKnownSecretEnvVarNames;exports.t = getProviderEnvVars;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function normalizePluginConfigId$1(id) {
  return (0, _stringCoerceBUSzWgUA.o)(id) ?? "";
}
...
function resolveProviderAuthAliasMap(params) {
  ...
  for (const plugin of registry.plugins) {
    ...
    for (const [alias, target] of Object.entries(plugin.providerAuthAliases ?? {}).toSorted(([left], [right]) => left.localeCompare(right))) {
      const normalizedAlias = (0, _providerIdKaStHhRz.r)(alias);
      const normalizedTarget = (0, _providerIdKaStHhRz.r)(target);
...
function isWorkspacePluginTrustedForProviderEnvVars(plugin, config) {
  ...
  return (0, _slotsMFUVcT3n.r)(plugin.kind, "context-engine") && normalizePluginConfigId(pluginsConfig?.slots?.contextEngine) === pluginId;
}
