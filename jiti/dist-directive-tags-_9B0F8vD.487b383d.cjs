"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = stripInlineDirectiveTagsFromMessageForDisplay;exports.n = stripInlineDirectiveTagsForDelivery;exports.r = stripInlineDirectiveTagsForDisplay;exports.t = parseInlineDirectives;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function parseInlineDirectives(text, options = {}) {
  ...
  const replyToId = lastExplicitId ?? (sawCurrent ? (0, _stringCoerceBUSzWgUA.s)(currentMessageId) : void 0);
  return {
    text: cleaned,
    audioAsVoice,
    replyToId,
