"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = projectAccountConfigWarningCollector;exports.D = projectWarningCollector;exports.E = projectConfigWarningCollector;exports.S = createOpenProviderGroupPolicyWarningCollector;exports.T = projectConfigAccountIdWarningCollector;exports._ = createAllowlistProviderRestrictSendersWarningCollector;exports.a = buildOpenGroupPolicyConfigureRouteAllowlistWarning;exports.b = createOpenGroupPolicyRestrictSendersWarningCollector;exports.c = collectAllowlistProviderGroupPolicyWarnings;exports.d = collectOpenGroupPolicyRouteAllowlistWarnings;exports.f = collectOpenProviderGroupPolicyWarnings;exports.g = createAllowlistProviderOpenWarningCollector;exports.h = createAllowlistProviderGroupPolicyWarningCollector;exports.i = normalizeAllowFromList;exports.l = collectAllowlistProviderRestrictSendersWarnings;exports.m = composeWarningCollectors;exports.n = createDangerousNameMatchingMutableAllowlistWarningCollector;exports.o = buildOpenGroupPolicyRestrictSendersWarning;exports.p = composeAccountWarningCollectors;exports.r = createRestrictSendersChannelSecurity;exports.s = buildOpenGroupPolicyWarning;exports.t = coerceNativeSetting;exports.u = collectOpenGroupPolicyRestrictSendersWarnings;exports.v = createAllowlistProviderRouteAllowlistWarningCollector;exports.w = projectAccountWarningCollector;exports.x = createOpenProviderConfiguredRouteWarningCollector;exports.y = createConditionalWarningCollector;var _ansiBs_ZZlnS = require("./ansi-Bs_ZZlnS.js");
var _channelConfigHelpers9F9ZxFrZ = require("./channel-config-helpers-9F9ZxFrZ.js");
var _runtimeGroupPolicyB7UthCu = require("./runtime-group-policy-B7-UthCu.js");
var _dangerousNameMatchingC88BNn_A = require("./dangerous-name-matching-C88BNn_A.js");
...
function collectAllowlistProviderGroupPolicyWarnings(params) {
  const defaultGroupPolicy = (0, _runtimeGroupPolicyB7UthCu.r)(params.cfg);
  const { groupPolicy } = (0, _runtimeGroupPolicyB7UthCu.n)({
    providerConfigPresent: params.providerConfigPresent,
...
function collectOpenProviderGroupPolicyWarnings(params) {
  const defaultGroupPolicy = (0, _runtimeGroupPolicyB7UthCu.r)(params.cfg);
  const { groupPolicy } = (0, _runtimeGroupPolicyB7UthCu.i)({
    providerConfigPresent: params.providerConfigPresent,
    groupPolicy: params.configuredGroupPolicy ?? void 0,
    defaultGroupPolicy
  });
...
function collectMutableAllowlistWarningLines(hits, channel) {
  ...
  const exampleLines = hits.slice(0, 8).map((hit) => `- ${(0, _ansiBs_ZZlnS.t)(hit.path)}: ${(0, _ansiBs_ZZlnS.t)(hit.entry)}`);
  ...
  const flagHint = flagPaths.length === 1 ? (0, _ansiBs_ZZlnS.t)(flagPaths[0] ?? "") : `${(0, _ansiBs_ZZlnS.t)(flagPaths[0] ?? "")} (and ${flagPaths.length - 1} other scope flags)`;
  return [
...
function createDangerousNameMatchingMutableAllowlistWarningCollector(params) {
  return ({ cfg }) => {
    const hits = [];
    for (const scope of (0, _dangerousNameMatchingC88BNn_A.t)(cfg, params.channel)) {
...
function createRestrictSendersChannelSecurity(params) {
  return {
    resolveDmPolicy: (0, _channelConfigHelpers9F9ZxFrZ.u)({
