"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = defineSetupPluginEntry;exports.c = stripTargetKindPrefix;exports.i = defineChannelPluginEntry;exports.n = createChannelPluginBase;exports.o = getChatChannelMeta;exports.r = createChatChannelPlugin;exports.s = stripChannelTargetPrefix;exports.t = buildChannelOutboundSessionRoute;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
require("./subsystem-Cgmckbux.js");
require("./paths-Dvv9VRAc.js");
require("./types.secrets-CeL3gSMO.js");
require("./net-lBInRHnX.js");
var _configSchemaSgVTuroC = require("./config-schema-sgVTuroC.js");
var _registryCENZffQG = require("./registry-CENZffQG.js");
require("./delegate-C6gGfaoC.js");
require("./common-BWtun2If.js");
require("./typebox-UTirCdtG.js");
require("./resolve-route-ByaGTmFk.js");
var _helpersD33sU6YZ = require("./helpers-D33sU6YZ.js");
var _threadingHelpersC7ctZgCm = require("./threading-helpers-C7ctZgCm.js");
var _baseSessionKeyBsvxOl2v = require("./base-session-key-BsvxOl2v.js");
require("./setup-helpers-NxWLbAbV.js");
require("./secret-file-BlBf_gtc.js");
require("./tailscale-status-CR9Damf4.js");
require("./persistent-bindings.lifecycle-Cz29izxZ.js");
...
function resolveSdkChatChannelMeta(id) {
  cachedSdkChatChannelMeta ??= (0, _registryCENZffQG.l)();
...
function stripChannelTargetPrefix(raw, ...providers) {
  ...
  for (const provider of providers) {
    const prefix = `${(0, _stringCoerceBUSzWgUA.i)(provider)}:`;
    if ((0, _stringCoerceBUSzWgUA.i)(trimmed).startsWith(prefix)) return trimmed.slice(prefix.length).trim();
  }
  return trimmed;
}
...
function buildChannelOutboundSessionRoute(params) {
  const baseSessionKey = (0, _baseSessionKeyBsvxOl2v.t)({
    cfg: params.cfg,
...
function defineChannelPluginEntry({ id, name, description, plugin, configSchema, setRuntime, registerCliMetadata, registerFull }) {
  return {
    ...
    name,
    description,
    configSchema: typeof configSchema === "function" ? configSchema() : configSchema ?? (0, _configSchemaSgVTuroC.a)(),
    register(api) {
...
function resolveChatChannelSecurity(security) {
  ...
  return {
    resolveDmPolicy: ({ cfg, accountId, account }) => (0, _helpersD33sU6YZ.t)({
      cfg,
...
function resolveChatChannelThreading(threading) {
  ...
  if ("topLevelReplyToMode" in threading) resolveReplyToMode = (0, _threadingHelpersC7ctZgCm.r)(threading.topLevelReplyToMode);else
  resolveReplyToMode = (0, _threadingHelpersC7ctZgCm.t)(threading.scopedAccountReplyToMode);
  return {
    ...threading,
    resolveReplyToMode
  };
