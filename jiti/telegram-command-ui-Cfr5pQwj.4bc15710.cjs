"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = buildTelegramModelsProviderChannelData;exports.c = buildModelsKeyboard;exports.d = getModelsPageSize;exports.f = parseModelCallbackData;exports.i = buildTelegramModelsListChannelData;exports.l = buildProviderKeyboard;exports.n = buildTelegramCommandsListChannelData;exports.o = buildBrowseProvidersButton;exports.p = resolveModelSelection;exports.r = buildTelegramModelBrowseChannelData;exports.s = buildModelSelectionCallbackData;exports.t = buildCommandsPaginationKeyboard;exports.u = calculateTotalPages;var _approvalCallbackDataCBvBvRhW = require("./approval-callback-data-CBvBvRhW.js");
...
function buildModelSelectionCallbackData(params) {
  ...
  if ((0, _approvalCallbackDataCBvBvRhW.t)(fullCallbackData)) return fullCallbackData;
  const compactCallbackData = `${CALLBACK_PREFIX.selectCompact}${params.model}`;
  return (0, _approvalCallbackDataCBvBvRhW.t)(compactCallbackData) ? compactCallbackData : null;
}
