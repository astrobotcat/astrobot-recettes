"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = shouldSkipQueueItem;exports.a = getExistingFollowupQueue;exports.c = applyQueueDropPolicy;exports.d = buildCollectPrompt;exports.f = clearQueueSummaryState;exports.g = previewQueueSummaryPrompt;exports.h = hasCrossChannelItems;exports.i = clearFollowupQueue;exports.l = applyQueueRuntimeSettings;exports.m = drainNextQueueItem;exports.n = resolveQueueSettings$1;exports.o = getFollowupQueue;exports.p = drainCollectQueueStep;exports.r = void 0;exports.s = refreshQueuedFollowupSession;exports.t = resolveQueueSettings;exports.u = beginQueueDrain;exports.v = waitForQueueDebounce;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
var _directiveBJ5MwiY = require("./directive-BJ5MwiY2.js");
...
const FOLLOWUP_QUEUES = exports.r = (0, _globalSingletonB80lDOJ.t)(Symbol.for("openclaw.followupQueues"));
...
function refreshQueuedFollowupSession(params) {
  ...
  const rewriteRun = (run) => {
    ...
    if (shouldRewriteSession && run.sessionId === params.previousSessionId) {
      ...
      const nextSessionFile = (0, _stringCoerceBUSzWgUA.s)(params.nextSessionFile);
    ...
    if (shouldRewriteSelection) {
      ...
      if (Object.hasOwn(params, "nextAuthProfileId")) run.authProfileId = (0, _stringCoerceBUSzWgUA.s)(params.nextAuthProfileId);
...
function resolveQueueSettings$1(params) {
  const channelKey = (0, _stringCoerceBUSzWgUA.o)(params.channel);
  const queueCfg = params.cfg.messages?.queue;
  const providerModeRaw = channelKey && queueCfg?.byChannel ? queueCfg.byChannel[channelKey] : void 0;
  const resolvedMode = params.inlineMode ?? (0, _directiveBJ5MwiY.r)(params.sessionEntry?.queueMode) ?? (0, _directiveBJ5MwiY.r)(providerModeRaw) ?? (0, _directiveBJ5MwiY.r)(queueCfg?.mode) ?? defaultQueueModeForChannel(channelKey);
  ...
  const dropRaw = params.inlineOptions?.dropPolicy ?? params.sessionEntry?.queueDrop ?? (0, _directiveBJ5MwiY.n)(queueCfg?.drop) ?? "summarize";
  return {
    mode: resolvedMode,
...
function resolvePluginDebounce(channelKey) {
  ...
  const value = (0, _registryDelpa74L.t)(channelKey)?.defaults?.queue?.debounceMs;
  return typeof value === "number" && Number.isFinite(value) ? Math.max(0, value) : void 0;
}
