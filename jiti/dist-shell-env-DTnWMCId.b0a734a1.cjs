"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = shouldDeferShellEnvFallback;exports.i = resolveShellEnvFallbackTimeoutMs;exports.n = getShellPathFromLoginShell;exports.o = shouldEnableShellEnvFallback;exports.r = loadShellEnvFallback;exports.t = getShellEnvAppliedKeys;var _errorsD8p6rxH = require("./errors-D8p6rxH8.js");
var _envBiSxzotM = require("./env-BiSxzotM.js");
...
function resolveShellExecEnv(env) {
  const execEnv = (0, _hostEnvSecurityC2piJKe.o)({ baseEnv: env });
...
function shouldEnableShellEnvFallback(env) {
  return (0, _envBiSxzotM.t)(env.OPENCLAW_LOAD_SHELL_ENV);
}
function shouldDeferShellEnvFallback(env) {
  return (0, _envBiSxzotM.t)(env.OPENCLAW_DEFER_SHELL_ENV_FALLBACK);
}
