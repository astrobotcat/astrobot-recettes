"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = countActiveRunsForSessionFromRuns;exports.c = findRunIdsByChildSessionKeyFromRuns;exports.d = listRunsForRequesterFromRuns;exports.f = resolveRequesterForChildSessionFromRuns;exports.i = countActiveDescendantRunsFromRuns;exports.l = listDescendantRunsForRequesterFromRuns;exports.m = void 0;exports.n = persistSubagentRunsToDisk;exports.o = countPendingDescendantRunsExcludingRunFromRuns;exports.p = shouldIgnorePostCompletionAnnounceForSessionFromRuns;exports.r = restoreSubagentRunsFromDisk;exports.s = countPendingDescendantRunsFromRuns;exports.t = getSubagentRunsSnapshotForRead;exports.u = listRunsForControllerFromRuns;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
const subagentRuns = exports.m = /* @__PURE__ */new Map();
//#endregion
...
function resolveSubagentStateDir(env = process.env) {
  ...
  if (env.VITEST || env.NODE_ENV === "test") return _nodePath.default.join(_nodeOs.default.tmpdir(), "openclaw-test-state", String(process.pid));
  return (0, _pathsDvv9VRAc._)(env);
}
function resolveSubagentRegistryPath() {
  return _nodePath.default.join(resolveSubagentStateDir(process.env), "subagents", "runs.json");
}
function loadSubagentRegistryFromDisk() {
  const raw = (0, _jsonFileDAv7R9GL.t)(resolveSubagentRegistryPath());
  ...
  for (const [runId, entry] of Object.entries(runsRaw)) {
    ...
    const requesterOrigin = (0, _deliveryContextSharedEClQPjt.i)(typed.requesterOrigin ?? {
      channel: (0, _stringCoerceBUSzWgUA.d)(typed.requesterChannel),
      accountId: (0, _stringCoerceBUSzWgUA.d)(typed.requesterAccountId)
    });
    const childSessionKey = (0, _stringCoerceBUSzWgUA.d)(typed.childSessionKey)?.trim() ?? "";
    const requesterSessionKey = (0, _stringCoerceBUSzWgUA.d)(typed.requesterSessionKey)?.trim() ?? "";
    const controllerSessionKey = (0, _stringCoerceBUSzWgUA.d)(typed.controllerSessionKey)?.trim() || requesterSessionKey;
