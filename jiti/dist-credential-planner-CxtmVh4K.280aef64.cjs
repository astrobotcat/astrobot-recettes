"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = void 0;exports.i = trimCredentialToUndefined;exports.n = hasGatewayPasswordEnvCandidate;exports.r = hasGatewayTokenEnvCandidate;exports.t = createGatewayCredentialPlan;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
const trimToUndefined = exports.a = _stringCoerceBUSzWgUA.s;
/**
...
function trimCredentialToUndefined(value) {
  ...
  if (trimmed && (0, _envSubstitution3wGlQjxu.n)(trimmed)) return;
  return trimmed;
}
...
function resolveConfiguredGatewayCredentialInput(params) {
  ...
  return {
    path: params.path,
    configured: (0, _typesSecretsCeL3gSMO.a)(params.value, params.defaults),
