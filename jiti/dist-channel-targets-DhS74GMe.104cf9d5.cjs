"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveServicePrefixedChatTarget;exports.i = resolveServicePrefixedAllowTarget;exports.n = parseChatAllowTargetPrefixes;exports.o = resolveServicePrefixedOrChatAllowTarget;exports.r = parseChatTargetPrefixesOrThrow;exports.s = resolveServicePrefixedTarget;exports.t = createAllowedChatSenderMatcher;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
var _stringNormalizationXm3f27dv = require("./string-normalization-xm3f27dv.js");
require("./registry-Delpa74L.js");
//#region src/channels/plugins/chat-target-prefixes.ts
function isAllowedParsedChatSender(params) {
  const allowFrom = (0, _stringNormalizationXm3f27dv.s)(params.allowFrom);
  if (allowFrom.length === 0) return false;
  if (allowFrom.includes("*")) return true;
  const senderNormalized = params.normalizeSender(params.sender);
  const chatId = params.chatId ?? void 0;
  const chatGuid = (0, _stringCoerceBUSzWgUA.s)(params.chatGuid);
  const chatIdentifier = (0, _stringCoerceBUSzWgUA.s)(params.chatIdentifier);
...
function resolveServicePrefixedTarget(params) {
  for (const { prefix, service } of params.servicePrefixes) {
    ...
    const remainderLower = (0, _stringCoerceBUSzWgUA.i)(remainder);
