"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = validateEnvVarValue;exports.r = resolveSkillSource;exports.t = sanitizeEnvVars;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
//#region src/agents/skills/source.ts
function resolveSkillSource(skill) {
  const compatSkill = skill;
  const canonical = (0, _stringCoerceBUSzWgUA.s)(compatSkill.source) ?? "";
  if (canonical) return canonical;
  return ((0, _stringCoerceBUSzWgUA.s)(compatSkill.sourceInfo?.source) ?? "") || "unknown";
}
//#endregion
