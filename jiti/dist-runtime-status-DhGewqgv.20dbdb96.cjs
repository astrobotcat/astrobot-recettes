"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveSandboxRuntimeStatus;exports.t = formatSandboxToolPolicyBlockedMessage;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function resolveMainSessionKeyForSandbox(params) {
  ...
  return (0, _mainSessionDtefsIzj.n)({
    cfg: params.cfg,
    agentId: params.agentId
  });
}
function resolveComparableSessionKeyForSandbox(params) {
  return (0, _mainSessionDtefsIzj.t)({
    cfg: params.cfg,
    agentId: params.agentId,
...
function resolveSandboxRuntimeStatus(params) {
  ...
  const sandboxCfg = (0, _configCWqq9_ZP.n)(cfg, agentId);
  ...
  return {
    ...
    sandboxed,
    toolPolicy: (0, _configCWqq9_ZP.o)(cfg, agentId)
  };
}
...
function formatSandboxToolPolicyBlockedMessage(params) {
  const tool = (0, _stringCoerceBUSzWgUA.o)(params.toolName);
  if (!tool) return;
  ...
  const { blockedByDeny, blockedByAllow } = (0, _configCWqq9_ZP.i)(tool, runtime.toolPolicy);
  ...
  lines.push(`- See: ${(0, _commandFormatDd3uP.t)(explainCommand)}`);
  return lines.join("\n");
}
//#endregion /* v9-01d8433c72f9e1be */
