"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.agentLoop = agentLoop;exports.agentLoopContinue = agentLoopContinue;exports.runAgentLoop = runAgentLoop;exports.runAgentLoopContinue = runAgentLoopContinue;
...
async function prepareToolCall(currentContext, assistantMessage, toolCall, config, signal) {
  ...
  try {
    ...
    const validatedArgs = (0, _piAi.validateToolArguments)(tool, preparedToolCall);
