"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = parseVoiceCallPluginConfig;exports.n = migrateVoiceCallLegacyConfigInput;exports.r = normalizeVoiceCallLegacyConfigInput;exports.t = formatVoiceCallLegacyConfigWarnings;var _recordCoerceBls3blVy = require("./record-coerce-Bls3blVy.js");
require("./text-runtime-DTMxvodz.js");
var _configUYK0fdI = require("./config-u-yK0fdI.js");
//#region extensions/voice-call/src/config-compat.ts
const VOICE_CALL_LEGACY_CONFIG_REMOVAL_VERSION = "2026.6.0";
const asObject = _recordCoerceBls3blVy.i;
const getString = _recordCoerceBls3blVy.o;
...
function parseVoiceCallPluginConfig(value) {
  return _configUYK0fdI.t.parse(normalizeVoiceCallLegacyConfigInput(value));
}
//#endregion /* v9-7aaa9fbf347ec632 */
