...
async function walkDirectoryWithFd(baseDir, fdPath, query, maxResults, signal) {
  ...
  return await new Promise((resolve) => {
    ...
    const child = (0, _child_process.spawn)(fdPath, args, {
...
class CombinedAutocompleteProvider {
  ...
  resolveScopedFuzzyQuery(rawQuery) {
    ...
    {
      baseDir = (0, _path.join)(this.basePath, displayBase);
    }
    try {
      if (!(0, _fs.statSync)(baseDir).isDirectory()) {
        return null;
      }
    }
    catch {
...
}exports.CombinedAutocompleteProvider = CombinedAutocompleteProvider; /* v9-269571fa9db0ad48 */
