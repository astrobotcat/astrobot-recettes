"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isRequestBodyLimitError;exports.c = requestBodyErrorToText;exports.i = installRequestBodyLimitGuard;exports.n = void 0;exports.o = readJsonBodyWithLimit;exports.r = void 0;exports.s = readRequestBodyWithLimit;exports.t = void 0;var _errorsD8p6rxH = require("./errors-D8p6rxH8.js");
var _nodeTimers = require("node:timers");
//#region src/infra/http-body.ts
const DEFAULT_WEBHOOK_MAX_BODY_BYTES = exports.n = 1024 * 1024;
const DEFAULT_WEBHOOK_BODY_TIMEOUT_MS = exports.t = 3e4;
...
};exports.r = RequestBodyLimitError;
...
async function readRequestBodyWithLimit(req, options) {
  ...
  return await new Promise((resolve, reject) => {
    ...
    const timer = (0, _nodeTimers.setTimeout)(() => {
  ...
  try {
    ...
    try {
      ...
      return {
        ok: false,
        code: "INVALID_JSON",
        error: (0, _errorsD8p6rxH.i)(error)
      };
    }
  } catch (error) {
