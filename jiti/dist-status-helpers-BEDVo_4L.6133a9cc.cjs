"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = resolveEnabledConfiguredAccountId;exports.a = buildRuntimeAccountStatusSnapshot;exports.c = collectStatusIssuesFromLastError;exports.d = createDefaultChannelRuntimeState;exports.f = createDependentCredentialStatusIssueCollector;exports.g = formatMatchMetadata;exports.h = collectIssuesForEnabledAccounts;exports.i = buildProbeChannelStatusSummary;exports.l = createAsyncComputedAccountStatusAdapter;exports.m = asString;exports.n = buildBaseChannelStatusSummary;exports.o = buildTokenChannelStatusSummary;exports.p = appendMatchMetadata;exports.r = buildComputedAccountStatusSnapshot;exports.s = buildWebhookChannelStatusSummary;exports.t = buildBaseAccountStatusSnapshot;exports.u = createComputedAccountStatusAdapter;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
require("./utils-D5DtWkEu.js");
//#region src/channels/plugins/status-issues/shared.ts
function asString(value) {
  return typeof value === "string" ? (0, _stringCoerceBUSzWgUA.s)(value) : void 0;
}
...
function createDependentCredentialStatusIssueCollector(options) {
  const isDependencyConfigured = options.isDependencyConfigured ?? ((value) => {
    const normalized = typeof value === "string" ? (0, _stringCoerceBUSzWgUA.s)(value) : void 0;
