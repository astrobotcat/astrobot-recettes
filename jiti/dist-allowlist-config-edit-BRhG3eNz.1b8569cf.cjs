"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = collectNestedAllowlistOverridesFromRecord;exports.c = createNestedAllowlistOverrideResolver;exports.d = resolveLegacyDmAllowlistConfigPaths;exports.i = collectAllowlistOverridesFromRecord;exports.l = readConfiguredAllowlistEntries;exports.n = buildDmGroupAccountAllowlistAdapter;exports.o = createAccountScopedAllowlistNameResolver;exports.r = buildLegacyDmAccountAllowlistAdapter;exports.s = createFlatAllowlistOverrideResolver;exports.t = buildAccountScopedAllowlistConfigEditor;exports.u = resolveDmGroupAllowlistConfigPaths;var _prototypeKeysCnLLLhBE = require("./prototype-keys-CnLLLhBE.js");
...
function resolveAccountScopedWriteTarget(parsed, channelId, accountId) {
  ...
  if ((0, _prototypeKeysCnLLLhBE.t)(normalizedAccountId)) return {
    target: channel,
...
function applyAccountScopedAllowlistConfigEdit(params) {
  ...
  if (changed) {
    if (next.length === 0) deleteNestedValue(resolvedTarget.target, params.paths.writePath);else
