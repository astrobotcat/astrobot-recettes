...
var _utils = require("./utils.js"); /* IMPORT */
/* HELPERS */
  ...
  outer: while (true) {
    ...
    if (unmatchedEnd > unmatchedStart || index >= length && index > indexPrev) {
      ...
      for (const char of unmatched.replaceAll(MODIFIER_RE, '')) {
        ...
        if ((0, _utils.isFullWidth)(codePoint)) {
          widthExtra = FULL_WIDTH_WIDTH;
        } else
        if ((0, _utils.isWide)(codePoint)) {
          widthExtra = WIDE_WIDTH;
        } else
        if (AMBIGUOUS_WIDTH !== REGULAR_WIDTH && (0, _utils.isAmbiguous)(codePoint)) {
...
getStringTruncatedWidth; /* v9-4ce02d2888faddbd */
