"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveIdentityNamePrefix;exports.i = resolveHumanDelayConfig;exports.n = resolveAgentIdentity;exports.o = resolveMessagePrefix;exports.r = resolveEffectiveMessagesConfig;exports.s = resolveResponsePrefix;exports.t = resolveAckReaction;var _agentScopeKFH9bkHi = require("./agent-scope-KFH9bkHi.js");
//#region src/agents/identity.ts
const DEFAULT_ACK_REACTION = "👀";
function resolveAgentIdentity(cfg, agentId) {
  return (0, _agentScopeKFH9bkHi._)(cfg, agentId)?.identity;
}
...
function resolveHumanDelayConfig(cfg, agentId) {
  ...
  const overrides = (0, _agentScopeKFH9bkHi._)(cfg, agentId)?.humanDelay;
