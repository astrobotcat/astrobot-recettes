"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = sanitizeTaskStatusText;exports.i = formatTaskStatusTitleText;exports.n = formatTaskStatusDetail;exports.r = formatTaskStatusTitle;exports.t = buildTaskStatusSnapshot;var _utilsD5DtWkEu = require("./utils-D5DtWkEu.js");
...
function truncateTaskStatusText(value, maxChars) {
  ...
  return `${(0, _utilsD5DtWkEu.b)(trimmed, Math.max(0, maxChars - 1)).trimEnd()}…`;
}
function stripInlineLeakedInternalContext(value) {
  const beginIndex = value.indexOf(_sanitizeUserFacingTextCQF1CTnZ.f);
...
function sanitizeTaskStatusValue(value, errorContext) {
  if (typeof value === "string") return (0, _sanitizeUserFacingTextCQF1CTnZ.u)(stripInlineLeakedInternalContext(value), { errorContext }).replace(/\s+/g, " ").trim() || void 0;
