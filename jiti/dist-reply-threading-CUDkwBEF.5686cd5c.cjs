"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = createReplyReferencePlanner;exports.i = resolveReplyToMode;exports.n = resolveBatchedReplyThreadingPolicy;exports.o = isSingleUseReplyToMode;exports.r = resolveImplicitCurrentMessageReplyAllowance;exports.t = createReplyToModeFilterForChannel;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function createReplyReferencePlanner(options) {
  ...
  const existingId = (0, _stringCoerceBUSzWgUA.s)(options.existingId);
  const startId = (0, _stringCoerceBUSzWgUA.s)(options.startId);
  const use = () => {
...
function resolveConfiguredReplyToMode(cfg, channel, chatType) {
  const provider = (0, _registryCENZffQG.a)(channel) ?? (0, _stringCoerceBUSzWgUA.o)(channel);
