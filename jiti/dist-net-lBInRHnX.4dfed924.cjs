...
var _tailnetCVzI7jiq = require("./tailnet-CVzI7jiq.js");
...
function pickPrimaryLanIPv4() {
  return (0, _tailnetCVzI7jiq.i)((0, _tailnetCVzI7jiq.a)(), {
    family: "IPv4",
    preferredNames: ["en0", "eth0"]
  });
}
function normalizeHostHeader(hostHeader) {
  return (0, _stringCoerceBUSzWgUA.i)(hostHeader);
}
...
function isPrivateOrLoopbackAddress(ip) {
  return (0, _ipC5y47j8x.d)(ip);
}
function normalizeIp(ip) {
  return (0, _ipC5y47j8x.p)(ip);
}
...
function isTrustedProxyAddress(ip, trustedProxies) {
  ...
  return trustedProxies.some((proxy) => {
    ...
    return (0, _ipC5y47j8x.o)(normalized, candidate);
  });
}
...
async function resolveGatewayBindHost(bind, customHost) {
  ...
  if (mode === "tailnet") {
    const tailnetIP = (0, _tailnetCVzI7jiq.n)();
...
function parseHostForAddressChecks(host) {
  if (!host) return null;
  const normalizedHost = (0, _stringCoerceBUSzWgUA.i)(host);
