"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveSessionLockMaxHoldFromTimeout;exports.n = cleanStaleLockFiles;exports.r = drainSessionWriteLockStateForTest;exports.t = acquireSessionWriteLock;var _pidAliveCu1HI9Ug = require("./pid-alive-Cu1HI9Ug.js");
...
const HELD_LOCKS = (0, _processScopedMapCwdLiqvv.t)(HELD_LOCKS_KEY);
...
function inspectLockPayload(payload, staleMs, nowMs) {
  ...
  const pidAlive = pid !== null ? (0, _pidAliveCu1HI9Ug.n)(pid) : false;
  ...
  const pidRecycled = pidAlive && pid !== null && storedStarttime !== null ? (() => {
    const currentStarttime = (0, _pidAliveCu1HI9Ug.t)(pid);
...
async function acquireSessionWriteLock(params) {
  ...
  while (Date.now() - startedAt < timeoutMs) {
    ...
    try {
      ...
      const starttime = (0, _pidAliveCu1HI9Ug.t)(process.pid);
      const lockPayload = {
        pid: process.pid,
        createdAt
      };
