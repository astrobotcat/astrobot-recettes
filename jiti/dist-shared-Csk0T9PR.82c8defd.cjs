"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = postTranscriptionRequest;exports.c = resolveProviderOperationTimeoutMs;exports.i = postJsonRequest;exports.l = waitProviderOperationPollInterval;exports.n = createProviderOperationDeadline;exports.o = requireTranscriptionText;exports.r = fetchWithTimeoutGuarded;exports.s = resolveProviderHttpRequestConfig;exports.t = assertOkOrThrowHttpError;var _proxyEnvQIN1SJGt = require("./proxy-env-qIN1SJGt.js");
...
function resolveProviderHttpRequestConfig(params) {
  const requestConfig = (0, _providerRequestConfigS_W3yUlE.c)({
  ...
  return {
    ...
    headers,
    dispatcherPolicy: (0, _providerRequestConfigS_W3yUlE.n)(requestConfig),
    requestConfig
  };
}
/**
...
function shouldAutoUpgradeToTrustedEnvProxy(params) {
  ...
  if (!(0, _proxyEnvQIN1SJGt.n)(protocol)) return false;
  if ((0, _proxyEnvQIN1SJGt.i)(params.url)) return false;
  return true;
}
async function fetchWithTimeoutGuarded(url, init, timeoutMs, fetchFn, options) {
  ...
  }) ? _fetchGuardB3p4gGaY.t.TRUSTED_ENV_PROXY : void 0);
  return await (0, _fetchGuardB3p4gGaY.n)({
    url,
    fetchImpl: fetchFn,
    init,
