...
function isTailnetIPv4(address) {
  return (0, _ipC5y47j8x.o)(address, TAILNET_IPV4_CIDR);
}
function isTailnetIPv6(address) {
  return (0, _ipC5y47j8x.o)(address, TAILNET_IPV6_CIDR);
}
