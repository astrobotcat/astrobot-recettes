"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.LoginDialogComponent = void 0;var _oauth = require("@mariozechner/pi-ai/oauth");
...
class LoginDialogComponent extends _piTui.Container {
  ...
  showPrompt(message, placeholder) {
    ...
    this.contentContainer.addChild(this.input);
    this.contentContainer.addChild(new _piTui.Text(`(${(0, _keybindingHints.keyHint)("tui.select.cancel", "to cancel,")} ${(0, _keybindingHints.keyHint)("tui.select.confirm", "to submit")})`, 1, 0));
    this.input.setValue("");
    this.tui.requestRender();
    return new Promise((resolve, reject) => {
      this.inputResolver = resolve;
...
}exports.LoginDialogComponent = LoginDialogComponent; /* v9-58b71914fd1145af */
