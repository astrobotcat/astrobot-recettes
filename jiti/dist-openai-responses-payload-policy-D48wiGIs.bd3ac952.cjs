"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveOpenAIResponsesPayloadPolicy;exports.r = flattenCompletionMessagesToStringContent;exports.t = applyOpenAIResponsesPayloadPolicy;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function resolveOpenAIResponsesPayloadPolicy(model, options = {}) {
  const capabilities = (0, _providerRequestConfigS_W3yUlE.c)({
    provider: (0, _stringCoerceBUSzWgUA.d)(model.provider),
    api: (0, _stringCoerceBUSzWgUA.d)(model.api),
    baseUrl: (0, _stringCoerceBUSzWgUA.d)(model.baseUrl),
    compat: model.compat,
    capability: "llm",
    transport: "stream"
  }).capabilities;
