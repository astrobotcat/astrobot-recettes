"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = resolveBrowserRateLimitMessage;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
require("./text-runtime-DTMxvodz.js");
require("./browser-config-support-DeTP2_70.js");
...
function isBrowserbaseUrl(url) {
  ...
  try {
    const host = (0, _stringCoerceBUSzWgUA.i)(new URL(url).hostname);
