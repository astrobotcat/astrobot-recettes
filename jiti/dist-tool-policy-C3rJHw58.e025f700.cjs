"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.C = void 0;exports.D = describeSessionsSendTool;exports.E = describeSessionsListTool;exports.O = describeSessionsSpawnTool;exports.S = void 0;exports.T = describeSessionsHistoryTool;exports._ = void 0;exports.a = expandPolicyWithPluginGroups;exports.b = void 0;exports.c = expandToolGroups;exports.d = void 0;exports.f = isKnownCoreToolId;exports.h = exports.g = void 0;exports.i = collectExplicitAllowlist;exports.k = describeUpdatePlanTool;exports.l = normalizeToolName;exports.m = resolveCoreToolProfiles;exports.n = applyOwnerOnlyToolPolicy;exports.o = mergeAlsoAllowPolicy;exports.p = listCoreToolSections;exports.r = buildPluginToolGroups;exports.s = resolveOwnerOnlyToolApprovalClass;exports.t = analyzeAllowlistByToolType;exports.u = resolveToolProfilePolicy;exports.v = void 0;exports.w = describeSessionStatusTool;exports.y = exports.x = void 0;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
//#region src/agents/tool-description-presets.ts
const EXEC_TOOL_DISPLAY_SUMMARY = exports.g = "Run shell commands that start now.";
const PROCESS_TOOL_DISPLAY_SUMMARY = exports._ = "Inspect and control running exec sessions.";
const CRON_TOOL_DISPLAY_SUMMARY = exports.h = "Schedule cron jobs, reminders, and wake events.";
const SESSIONS_LIST_TOOL_DISPLAY_SUMMARY = exports.y = "List visible sessions and optional recent messages.";
const SESSIONS_HISTORY_TOOL_DISPLAY_SUMMARY = exports.v = "Read sanitized message history for a visible session.";
const SESSIONS_SEND_TOOL_DISPLAY_SUMMARY = exports.b = "Send a message to another visible session.";
const SESSIONS_SPAWN_TOOL_DISPLAY_SUMMARY = exports.x = "Spawn sub-agent or ACP sessions.";
const SESSION_STATUS_TOOL_DISPLAY_SUMMARY = exports.S = "Show session status, usage, and model state.";
const UPDATE_PLAN_TOOL_DISPLAY_SUMMARY = exports.C = "Track a short structured work plan.";
...
const PROFILE_OPTIONS = exports.d = [
{
  id: "minimal",
  label: "Minimal"
},
...
function normalizeToolName(name) {
  const normalized = (0, _stringCoerceBUSzWgUA.i)(name);
...
function buildPluginToolGroups(params) {
  ...
  for (const tool of params.tools) {
    ...
    all.push(name);
    const pluginId = (0, _stringCoerceBUSzWgUA.o)(meta.pluginId);
