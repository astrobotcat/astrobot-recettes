"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = retryAsync;exports.t = resolveRetryConfig;var _utilsD5DtWkEu = require("./utils-D5DtWkEu.js");
var _numberCoercionCl2KmzKx = require("./number-coercion-Cl2KmzKx.js");
...
const clampNumber = (value, fallback, min, max) => {
  const next = (0, _numberCoercionCl2KmzKx.t)(value);
...
function applyJitter(delayMs, jitter) {
  ...
  const offset = ((0, _secureRandomDHoiZOqc.t)() * 2 - 1) * jitter;
...
async function retryAsync(fn, attemptsOrOptions = 3, initialDelayMs = 300) {
  if (typeof attemptsOrOptions === "number") {
    ...
    for (let i = 0; i < attempts; i += 1) try {
      ...
      await (0, _utilsD5DtWkEu.v)(initialDelayMs * 2 ** i);
    }
  ...
  for (let attempt = 1; attempt <= maxAttempts; attempt += 1) try {
    ...
    if (delay > 0) await (0, _utilsD5DtWkEu.v)(delay);
  }
  throw lastErr ?? /* @__PURE__ */new Error("Retry failed");
}
//#endregion /* v9-ab18a85ac5525faa */
