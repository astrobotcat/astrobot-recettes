...
const handlers = (0, _globalSingletonB80lDOJ.n)(Symbol.for("openclaw.internalHookHandlers"), () => /* @__PURE__ */new Map());
const internalHooksEnabledState = (0, _globalSingletonB80lDOJ.n)(Symbol.for("openclaw.internalHooksEnabled"), () => ({ enabled: true }));
const log = (0, _subsystemCgmckbux.t)("internal-hooks");
/**
