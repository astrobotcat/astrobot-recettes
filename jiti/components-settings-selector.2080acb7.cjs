...
class SelectSubmenu extends _piTui.Container {
  ...
  constructor(title, description, options, currentValue, onSelect, onCancel, onSelectionChange) {
    ...
    this.addChild(new _piTui.Spacer(1));
    // Select list
    this.selectList = new _piTui.SelectList(options, Math.min(options.length, 10), (0, _theme.getSelectListTheme)(), SETTINGS_SUBMENU_SELECT_LIST_LAYOUT);
...
}exports.SettingsSelectorComponent = SettingsSelectorComponent; /* v9-24a58ac88ae1b4b9 */
