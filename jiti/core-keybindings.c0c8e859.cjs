"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.KeybindingsManager = exports.KEYBINDINGS = void 0;exports.migrateKeybindingsConfig = migrateKeybindingsConfig;var _piTui = require("@mariozechner/pi-tui");
var _fs = require("fs");
var _path = require("path");
var _config = require("../config.js");
const KEYBINDINGS = exports.KEYBINDINGS = {
  ..._piTui.TUI_KEYBINDINGS,
...
function loadRawConfig(path) {
  ...
  return undefined;
  try {
    const parsed = JSON.parse((0, _fs.readFileSync)(path, "utf-8"));
...
class KeybindingsManager extends _piTui.KeybindingsManager {
  configPath;
...
}exports.KeybindingsManager = KeybindingsManager; /* v9-9596b0549821719e */
