"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveAwsSdkEnvVarName;exports.t = requireApiKey;var _normalizeSecretInputDqcJmob = require("./normalize-secret-input-DqcJmob1.js");
...
function requireApiKey(auth, provider) {
  const key = (0, _normalizeSecretInputDqcJmob.n)(auth.apiKey);
  if (key) return key;
  throw new Error(`No API key resolved for provider "${provider}" (auth mode: ${auth.mode}).`);
}
//#endregion /* v9-e05e6a9cdfd6f38a */
