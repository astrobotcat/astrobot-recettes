"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.fauxAssistantMessage = fauxAssistantMessage;exports.fauxText = fauxText;exports.fauxThinking = fauxThinking;exports.fauxToolCall = fauxToolCall;exports.registerFauxProvider = registerFauxProvider;var _apiRegistry = require("../api-registry.js");
...
function registerFauxProvider(options = {}) {
  ...
  const stream = (requestModel, context, streamOptions) => {
    const outer = (0, _eventStream.createAssistantMessageEventStream)();
  ...
  (0, _apiRegistry.registerApiProvider)({ api, stream, streamSimple }, sourceId);
  ...
  return {
    ...
    unregister() {
      (0, _apiRegistry.unregisterApiProviders)(sourceId);
    }
  };
} /* v9-bce6c873d174fb64 */
