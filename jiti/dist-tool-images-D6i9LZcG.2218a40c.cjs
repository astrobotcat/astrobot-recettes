"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = resolveImageSanitizationLimits;exports.n = sanitizeImageBlocks;exports.r = sanitizeToolResultImages;exports.t = sanitizeContentBlocksImages;var _subsystemCgmckbux = require("./subsystem-Cgmckbux.js");
var _base64BgT9iohk = require("./base64-BgT9iohk.js");
...
const log = (0, _subsystemCgmckbux.t)("agents/tool-images");
...
async function resizeImageBase64IfNeeded(params) {
  ...
  const meta = await (0, _imageOpsF0rEOT4L.a)(buf);
  ...
  const sideGrid = (0, _imageOpsF0rEOT4L.r)(params.maxDimensionPx, sideStart);
  let smallest = null;
  for (const side of sideGrid) for (const quality of _imageOpsF0rEOT4L.t) {
...
async function sanitizeContentBlocksImages(blocks, label, opts = {}) {
  ...
  for (const block of blocks) {
    ...
    const canonicalData = (0, _base64BgT9iohk.t)(data);
    if (!canonicalData) {
      out.push({
        type: "text",
