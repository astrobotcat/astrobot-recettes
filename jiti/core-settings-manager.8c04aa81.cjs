"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.SettingsManager = exports.InMemorySettingsStorage = exports.FileSettingsStorage = void 0;var _fs = require("fs");
...
class FileSettingsStorage {
  globalSettingsPath;
  projectSettingsPath;
  constructor(cwd = process.cwd(), agentDir = (0, _config.getAgentDir)()) {
    this.globalSettingsPath = (0, _path.join)(agentDir, "settings.json");
    this.projectSettingsPath = (0, _path.join)(cwd, _config.CONFIG_DIR_NAME, "settings.json");
  }
  ...
  withLock(scope, fn) {
    ...
    try {
      ...
      const fileExists = (0, _fs.existsSync)(path);
      if (fileExists) {
        release = this.acquireLockSyncWithRetry(path);
      }
      const current = fileExists ? (0, _fs.readFileSync)(path, "utf-8") : undefined;
      ...
      if (next !== undefined) {
        ...
        (0, _fs.writeFileSync)(path, next, "utf-8");
      }
    } finally
    {
      if (release) {
...
}exports.SettingsManager = SettingsManager; /* v9-d3ffc40d9e44b5b4 */
