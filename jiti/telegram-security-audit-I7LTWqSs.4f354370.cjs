"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = collectTelegramSecurityAuditFindings;var _allowFromBSf89MjI = require("./allow-from-BSf89MjI.js");
var _conversationRuntime = require("openclaw/plugin-sdk/conversation-runtime");
var _nativeCommandConfigRuntime = require("openclaw/plugin-sdk/native-command-config-runtime");
...
function collectInvalidTelegramAllowFromEntries(params) {
  ...
  for (const entry of params.entries) {
    ...
    if (!(0, _allowFromBSf89MjI.t)(normalized)) params.target.add(normalized);
  }
}
