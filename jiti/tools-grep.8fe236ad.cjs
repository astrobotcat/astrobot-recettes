"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.createGrepTool = createGrepTool;exports.createGrepToolDefinition = createGrepToolDefinition;exports.grepToolDefinition = exports.grepTool = void 0;var _nodeReadline = require("node:readline");
          ...
          try {
            ...
            const formatBlock = async (filePath, lineNumber) => {
              ...
              for (let current = start; current <= end; current++) {
                ...
                linesTruncated = true;
                if (isMatchLine)
                block.push(`${relativePath}:${current}: ${truncatedText}`);else
...
const grepToolDefinition = exports.grepToolDefinition = createGrepToolDefinition(process.cwd());
const grepTool = exports.grepTool = createGrepTool(process.cwd()); /* v9-3fb6e3431b31f9c1 */
