"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = assertNoOAuthSecretRefPolicyViolations;var _typesSecretsCeL3gSMO = require("./types.secrets-CeL3gSMO.js");
...
function hasSecretRefInput(params) {
  return (0, _typesSecretsCeL3gSMO.d)({
    value: params.value,
...
function collectTypeOAuthSecretRefViolations(params) {
  ...
  "keyRef"])
  {
    if ((0, _typesSecretsCeL3gSMO.i)(record[field], params.defaults) === null) continue;
