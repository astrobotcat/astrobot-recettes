"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveHeartbeatReasonKind;exports.i = setHeartbeatsEnabled;exports.n = requestHeartbeatNow;exports.r = setHeartbeatWakeHandler;exports.t = areHeartbeatsEnabled;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
//#region src/infra/heartbeat-reason.ts
function trimReason(reason) {
  return (0, _stringCoerceBUSzWgUA.s)(reason) ?? "";
}
...
function normalizeWakeTarget(value) {
  return ((0, _stringCoerceBUSzWgUA.s)(value) ?? "") || void 0;
}
