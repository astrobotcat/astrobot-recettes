"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.$ = resolveAgentMaxConcurrent;exports.A = setConfigOverride;exports.B = normalizeLegacyBrowserConfig;exports.C = collectChannelSchemaMetadata;exports.D = applyConfigOverrides;exports.E = resolveShellEnvExpectedKeys;exports.F = unsetConfigValueAtPath;exports.G = seedMissingDefaultAccountsFromSingleAccountBase;exports.H = normalizeLegacyMediaProviderOptions;exports.I = asResolvedSourceConfig;exports.J = normalizeGoogleApiBaseUrl;exports.K = normalizeLegacyTalkConfig;exports.L = asRuntimeConfig;exports.M = getConfigValueAtPath;exports.N = parseConfigPath;exports.O = getConfigOverrides;exports.P = setConfigValueAtPath;exports.Q = resolveBundledProviderPolicySurface;exports.R = findLegacyConfigIssues;exports.S = validateConfigObjectWithPlugins;exports.T = void 0;exports.U = normalizeLegacyMistralModelMaxTokens;exports.V = normalizeLegacyCrossContextMessageConfig;exports.W = normalizeLegacyNanoBananaSkill;exports.X = normalizeTalkSection;exports.Y = buildTalkConfigResponse;exports.Z = resolveActiveTalkProviderConfig;exports._ = normalizeOpenClawVersionBase;exports.a = loadConfig;exports.at = listPluginDoctorLegacyConfigRules;exports.b = validateConfigObjectRaw;exports.c = readBestEffortConfig;exports.d = readSourceConfigBestEffort;exports.et = resolveSubagentMaxConcurrent;exports.f = readSourceConfigSnapshot;exports.g = writeConfigFile;exports.h = resolveConfigSnapshotHash;exports.i = getRuntimeConfig;exports.it = collectRelevantDoctorPluginIds;exports.j = unsetConfigOverride;exports.k = resetConfigOverrides;exports.l = readConfigFileSnapshot;exports.m = registerConfigWriteListener;exports.n = clearConfigCache;exports.nt = migrateLegacyWebSearchConfig;exports.o = parseConfigJson5;exports.p = readSourceConfigSnapshotForWrite;exports.q = void 0;exports.r = createConfigIO;exports.rt = migrateLegacyXSearchConfig;exports.s = projectConfigOntoRuntimeSourceSnapshot;exports.t = void 0;exports.tt = applyLegacyDoctorMigrations;exports.u = readConfigFileSnapshotForWrite;exports.v = collectUnsupportedSecretRefPolicyIssues;exports.w = collectPluginSchemaMetadata;exports.x = validateConfigObjectRawWithPlugins;exports.y = validateConfigObject;exports.z = migrateLegacyWebFetchConfig;var _errorsD8p6rxH = require("./errors-D8p6rxH8.js");
...
var _stateDirDotenvCh7ZMbTt = require("./state-dir-dotenv-Ch7ZMbTt.js");
...
var _ownerDisplayCR4JL3B = require("./owner-display-CR4JL3B8.js");
...
var _publicSurfaceLoaderIj2r4j4v = require("./public-surface-loader-Ij2r4j4v.js");
...
var _gatewayControlUiOriginsDBSlcLoG = require("./gateway-control-ui-origins-DBSlcLoG.js");
...
var _setupPromotionHelpersB_4ArWJF = require("./setup-promotion-helpers-B_4ArWJF.js");
...
var _manifestCommandAliasesRuntimeDTknNvLF = require("./manifest-command-aliases.runtime-DTknNvLF.js");
var _avatarPolicyDEMOzJv = require("./avatar-policy-DEMOzJv4.js");
var _zodSchemaBO9ySEsE = require("./zod-schema-BO9ySEsE.js");
var _semverCompareB2EDRUg = require("./semver-compare-B2E-dRUg.js");
...
const CURRENT_MODULE_PATH = (0, _nodeUrl.fileURLToPath)("file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/dist/io-5pxHCi7V.js");
...
function getJiti(modulePath) {
  return (0, _jitiLoaderCacheD_0TILck.t)({
    cache: jitiLoaders,
    modulePath,
    importerUrl: "file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/dist/io-5pxHCi7V.js"
  });
}
...
function resolveContractApiPath(rootDir) {
  ...
  for (const extension of orderedExtensions) {
    const candidate = _nodePath.default.join(rootDir, `doctor-contract-api${extension}`);
    if (_nodeFs.default.existsSync(candidate)) return candidate;
  }
  for (const extension of orderedExtensions) {
    const candidate = _nodePath.default.join(rootDir, `contract-api${extension}`);
    if (_nodeFs.default.existsSync(candidate)) return candidate;
  }
  return null;
}
...
function hasLegacyElevenLabsTalkFields(raw) {
  const talk = (0, _recordCoerceBls3blVy.n)((0, _recordCoerceBls3blVy.n)(raw)?.talk);
...
function collectRelevantDoctorPluginIds(raw) {
  ...
  const root = (0, _recordCoerceBls3blVy.n)(raw);
  if (!root) return [];
  const channels = (0, _recordCoerceBls3blVy.n)(root.channels);
  if (channels) {
    for (const channelId of Object.keys(channels)) if (channelId !== "defaults") ids.add(channelId);
  }
  const pluginsEntries = (0, _recordCoerceBls3blVy.n)((0, _recordCoerceBls3blVy.n)(root.plugins)?.entries);
...
function collectRelevantDoctorPluginIdsForTouchedPaths(params) {
  const root = (0, _recordCoerceBls3blVy.n)(params.raw);
  if (!root) return [];
  const ids = /* @__PURE__ */new Set();
...
function ensureRecord$2(target, key) {
  ...
  if ((0, _utilsD5DtWkEu.l)(current)) return current;
  const next = {};
  target[key] = next;
  return next;
}
...
function collectRelevantDoctorChannelIds(raw) {
  const channels = (0, _utilsD5DtWkEu.l)(raw) && (0, _utilsD5DtWkEu.l)(raw.channels) ? raw.channels : null;
  if (!channels) return [];
...
function resolveBundledChannelCompatibilityNormalizer(channelId) {
  ...
  return (0, _bootstrapRegistryBI6Zdzz.t)(channelId)?.doctor?.normalizeCompatibilityConfig;
}
...
const getRecord = (value) => (0, _utilsD5DtWkEu.l)(value) ? value : null;
const ensureRecord$1 = (root, key) => {
  const existing = root[key];
  if ((0, _utilsD5DtWkEu.l)(existing)) return existing;
  const next = {};
  root[key] = next;
  return next;
};
const mergeMissing = (target, source) => {
  for (const [key, value] of Object.entries(source)) {
    if (value === void 0 || (0, _prototypeKeysCnLLLhBE.t)(key)) continue;
...
const mapLegacyAudioTranscription = (value) => {
  ...
  if (!(0, _execSafetyO7DICmgB.t)(rawExecutable)) return null;
...
function migrateThreadBindingsTtlHoursForPath(params) {
  ...
  if (hadIdleHours) params.changes.push(`Removed ${params.pathPrefix}.threadBindings.ttlHours (${params.pathPrefix}.threadBindings.idleHours already set).`);else
...
function moveLegacyStreamingShapeForPath(params) {
  ...
  if (params.resolveMode && (hadLegacyStreamMode || hadLegacyStreamingScalar)) {
    ...
    if (!hasOwnKey(streaming, "mode")) {
      ...
      if (typeof legacyStreaming === "boolean") params.changes.push(`Moved ${params.pathPrefix}.streaming (boolean) → ${params.pathPrefix}.streaming.mode (${resolvedMode}).`);else
      if (typeof legacyStreaming === "string") params.changes.push(`Moved ${params.pathPrefix}.streaming (scalar) → ${params.pathPrefix}.streaming.mode (${resolvedMode}).`);
...
function migrateAllowAliasForPath(params) {
  ...
  if (hadEnabled) params.changes.push(`Removed ${params.pathPrefix}.allow (${params.pathPrefix}.enabled already set).`);else
...
const LEGACY_CONFIG_MIGRATIONS_RUNTIME_GATEWAY = [defineLegacyConfigMigration({
  ...
  apply: (raw, changes) => {
    ...
    if (!(0, _gatewayControlUiOriginsDBSlcLoG.i)(bind)) return;
    const controlUi = getRecord(gateway.controlUi) ?? {};
    if ((0, _gatewayControlUiOriginsDBSlcLoG.r)({
      allowedOrigins: controlUi.allowedOrigins,
      dangerouslyAllowHostHeaderOriginFallback: controlUi.dangerouslyAllowHostHeaderOriginFallback
    })) return;
    const origins = (0, _gatewayControlUiOriginsDBSlcLoG.t)({
      port: (0, _gatewayControlUiOriginsDBSlcLoG.a)(gateway.port, _pathsDvv9VRAc.n),
      bind,
  ...
  apply: (raw, changes) => {
    ...
    const normalized = (0, _stringCoerceBUSzWgUA.o)(bindRaw);
    if (!normalized) return;
    let mapped;
    if (normalized === "0.0.0.0" || normalized === "::" || normalized === "[::]" || normalized === "*") mapped = "lan";else
    if (normalized === "127.0.0.1" || normalized === "localhost" || normalized === "::1" || normalized === "[::1]") mapped = "loopback";
...
function resolveLegacyXSearchConfig(raw) {
  ...
  const tools = (0, _utilsD5DtWkEu.l)(raw.tools) ? raw.tools : void 0;
  const web = (0, _utilsD5DtWkEu.l)(tools?.web) ? tools.web : void 0;
  return (0, _utilsD5DtWkEu.l)(web?.x_search) ? web.x_search : void 0;
}
...
function migrateLegacyXSearchConfig(raw) {
  ...
  if (Object.keys(nextLegacy).length === 0) delete web.x_search;else
  ...
  const changes = [];
  if (auth !== void 0) {
    const existingWebSearch = (0, _utilsD5DtWkEu.l)(config.webSearch) ? cloneRecord(config.webSearch) : void 0;
...
function hasLegacyPluginEntryTtsProviderKeys(value) {
  ...
  return Object.entries(entries).some(([pluginId, entryValue]) => {
    if ((0, _prototypeKeysCnLLLhBE.t)(pluginId) || !LEGACY_TTS_PLUGIN_IDS.has(pluginId)) return false;
...
const LEGACY_CONFIG_MIGRATIONS_RUNTIME_TTS = [defineLegacyConfigMigration({
  ...
  apply: (raw, changes) => {
    ...
    for (const [pluginId, entryValue] of Object.entries(pluginEntries)) {
      if ((0, _prototypeKeysCnLLLhBE.t)(pluginId) || !LEGACY_TTS_PLUGIN_IDS.has(pluginId)) continue;
...
function getLegacyWebSearchProviderIds() {
  legacyWebSearchProviderIdsCache ??= (0, _manifestRegistryBd3A4lqx.t)({ cache: true }).plugins.filter((plugin) => plugin.origin === "bundled").flatMap((plugin) => plugin.contracts?.webSearchProviders ?? []).filter((providerId) => !NON_MIGRATED_LEGACY_WEB_SEARCH_PROVIDER_IDS.has(providerId)).toSorted((left, right) => left.localeCompare(right));
...
function resolveLegacySearchConfig(raw) {
  ...
  const tools = (0, _utilsD5DtWkEu.l)(raw.tools) ? raw.tools : void 0;
  const web = (0, _utilsD5DtWkEu.l)(tools?.web) ? tools.web : void 0;
  return (0, _utilsD5DtWkEu.l)(web?.search) ? web.search : void 0;
}
function copyLegacyProviderConfig(search, providerKey) {
  const current = search[providerKey];
  return (0, _utilsD5DtWkEu.l)(current) ? cloneRecord$1(current) : void 0;
}
function hasMappedLegacyWebSearchConfig(raw) {
  ...
  return getLegacyWebSearchProviderIds().some((providerId) => (0, _utilsD5DtWkEu.l)(search[providerId]));
}
function resolveLegacyGlobalWebSearchMigration(search) {
  ...
  const pluginId = (0, _manifestRegistryBd3A4lqx.n)({
...
function migratePluginWebSearchConfig(params) {
  ...
  const hadEnabled = entry.enabled !== void 0;
  const existing = (0, _utilsD5DtWkEu.l)(config.webSearch) ? cloneRecord$1(config.webSearch) : void 0;
  if (!hadEnabled) entry.enabled = true;
  if (!existing) {
...
function listLegacyWebSearchConfigPaths(raw) {
  ...
  for (const providerId of getLegacyWebSearchProviderIds()) {
    ...
    if ((0, _utilsD5DtWkEu.l)(scoped)) for (const key of Object.keys(scoped)) paths.push(`tools.web.search.${providerId}.${key}`);
  }
  return paths;
}
...
function normalizeLegacyWebSearchConfigRecord(raw) {
  ...
  for (const [key, value] of Object.entries(search)) {
    ...
    if (getLegacyWebSearchProviderIdSet().has(key) && (0, _utilsD5DtWkEu.l)(value)) continue;
    if (MODERN_SCOPED_WEB_SEARCH_KEYS.has(key) || !(0, _utilsD5DtWkEu.l)(value)) nextSearch[key] = value;
  }
...
function buildProviderPolicySurfaceCacheKey(providerId) {
  return `${providerId}::${(0, _bundledDirD4Wk35JT.t)() ?? "<default>"}`;
}
...
function tryLoadBundledProviderPolicySurface(pluginId) {
  for (const artifactBasename of PROVIDER_POLICY_ARTIFACT_CANDIDATES) try {
    const mod = (0, _publicSurfaceLoaderIj2r4j4v.t)({
      dirName: pluginId,
      artifactBasename
    });
...
function resolveBundledProviderPolicySurface(providerId) {
  const normalizedProviderId = (0, _providerIdKaStHhRz.r)(providerId);
...
function normalizeTalkSecretInput(value) {
  ...
  return (0, _typesSecretsCeL3gSMO.i)(value) ?? void 0;
}
...
function normalizeTalkProviders(value) {
  ...
  for (const [rawProviderId, providerConfig] of Object.entries(value)) {
    const providerId = (0, _stringCoerceBUSzWgUA.s)(rawProviderId);
...
function activeProviderFromTalk(talk) {
  const provider = (0, _stringCoerceBUSzWgUA.s)(talk.provider);
...
function normalizeTalkSection(value) {
  ...
  const provider = (0, _stringCoerceBUSzWgUA.s)(source.provider);
...
function buildTalkConfigResponse(value) {
  ...
  const activeProvider = (0, _stringCoerceBUSzWgUA.s)(normalized?.provider) ?? resolved?.provider;
...
function resolveNormalizedProviderModelMaxTokens(params) {
  ...
  if ((0, _providerIdKaStHhRz.r)(params.providerId) !== "mistral" || clamped < params.contextWindow) return clamped;
  ...
  if (providerConfig) {
    ...
    for (const [providerId, provider] of Object.entries(providerConfig)) {
      ...
      const nextModels = models.map((model) => {
        ...
        const contextWindow = isPositiveNumber(raw.contextWindow) ? raw.contextWindow : _defaultsCiQa3xnX.t;
...
const DEFAULT_GOOGLE_API_BASE_URL = exports.q = "https://generativelanguage.googleapis.com/v1beta";
...
function normalizeGoogleApiBaseUrl(baseUrl) {
  ...
  try {
    ...
    url.hash = "";
    url.search = "";
    if ((0, _providerAttributionBJhkfmfB.n)(url.toString()).endpointClass === "google-generative-ai" && trimTrailingSlashes(url.pathname || "") === "") url.pathname = "/v1beta";
...
function normalizeLegacyTalkConfig(cfg, changes) {
  ...
  if (Object.keys(normalizedTalk).length === 0 || (0, _nodeUtil.isDeepStrictEqual)(normalizedTalk, rawTalk)) return cfg;
...
function normalizeLegacyBrowserConfig(cfg, changes) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawBrowser)) return cfg;
  ...
  if ((0, _utilsD5DtWkEu.l)(rawProfiles)) {
    const profiles = { ...rawProfiles };
    let profilesChanged = false;
    for (const [profileName, rawProfile] of Object.entries(rawProfiles)) {
      if (!(0, _utilsD5DtWkEu.l)(rawProfile)) continue;
      if (((0, _stringCoerceBUSzWgUA.s)(rawProfile.driver) ?? "") !== "extension") continue;
  ...
  if ((0, _utilsD5DtWkEu.l)(rawSsrFPolicy) && "allowPrivateNetwork" in rawSsrFPolicy) {
    ...
    if (typeof legacyAllowPrivateNetwork === "boolean" || typeof currentDangerousAllowPrivateNetwork === "boolean") resolvedDangerousAllowPrivateNetwork = legacyAllowPrivateNetwork === true || currentDangerousAllowPrivateNetwork === true;else
...
function seedMissingDefaultAccountsFromSingleAccountBase(cfg, changes) {
  ...
  for (const [channelId, rawChannel] of Object.entries(channels)) {
    if (!(0, _utilsD5DtWkEu.l)(rawChannel)) continue;
    const rawAccounts = rawChannel.accounts;
    if (!(0, _utilsD5DtWkEu.l)(rawAccounts)) continue;
    const accountKeys = Object.keys(rawAccounts);
    if (accountKeys.length === 0) continue;
    if (accountKeys.some((key) => (0, _stringCoerceBUSzWgUA.o)(key) === "default")) continue;
    const keysToMove = (0, _setupPromotionHelpersB_4ArWJF.t)({
    ...
    nextChannel.accounts = {
      ...rawAccounts,
      [_accountIdJ7GeQlaZ.t]: defaultAccount
    };
...
function normalizeLegacyNanoBananaSkill(cfg, changes) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawSkills)) return cfg;
  let next = cfg;
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawEntries)) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawLegacyEntry)) {
    if (!skillsChanged) return cfg;
    return {
      ...cfg,
      skills
  ...
  const legacyEnvApiKey = (0, _stringCoerceBUSzWgUA.s)(((0, _utilsD5DtWkEu.l)(rawLegacyEntry.env) ? rawLegacyEntry.env : void 0)?.GEMINI_API_KEY) ?? "";
  const legacyApiKey = legacyEnvApiKey || (typeof rawLegacyEntry.apiKey === "string" ? (0, _stringCoerceBUSzWgUA.s)(rawLegacyEntry.apiKey) : rawLegacyEntry.apiKey && (0, _utilsD5DtWkEu.l)(rawLegacyEntry.apiKey) ? structuredClone(rawLegacyEntry.apiKey) : void 0);
  const rawModels = (0, _utilsD5DtWkEu.l)(next.models) ? structuredClone(next.models) : {};
  const rawProviders = (0, _utilsD5DtWkEu.l)(rawModels.providers) ? { ...rawModels.providers } : {};
  const rawGoogle = (0, _utilsD5DtWkEu.l)(rawProviders.google) ? { ...rawProviders.google } : {};
  ...
  if (Object.keys(entries).length === 0) delete skills.entries;else
...
function normalizeLegacyCrossContextMessageConfig(cfg, changes) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawTools)) return cfg;
  const rawMessage = rawTools.message;
  if (!(0, _utilsD5DtWkEu.l)(rawMessage) || !("allowCrossContextSend" in rawMessage)) return cfg;
  ...
  if (legacyAllowCrossContextSend) {
    const rawCrossContext = (0, _utilsD5DtWkEu.l)(nextMessage.crossContext) ? structuredClone(nextMessage.crossContext) : {};
...
function migrateLegacyDeepgramCompat(params) {
  const rawCompat = (0, _utilsD5DtWkEu.l)(params.owner.deepgram) ? structuredClone(params.owner.deepgram) : null;
  if (!rawCompat) return false;
  const compatProviderOptions = mapDeepgramCompatToProviderOptions(rawCompat);
  const currentProviderOptions = (0, _utilsD5DtWkEu.l)(params.owner.providerOptions) ? structuredClone(params.owner.providerOptions) : {};
  const currentDeepgram = (0, _utilsD5DtWkEu.l)(currentProviderOptions.deepgram) ? structuredClone(currentProviderOptions.deepgram) : {};
...
function normalizeLegacyMediaProviderOptions(cfg, changes) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawMedia)) return cfg;
  ...
  "video"])
  {
    const config = (0, _utilsD5DtWkEu.l)(nextMedia[capability]) ? structuredClone(nextMedia[capability]) : null;
    if (!config) continue;
...
function normalizeLegacyMistralModelMaxTokens(cfg, changes) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(rawProviders)) return cfg;
  let providersChanged = false;
  const nextProviders = { ...rawProviders };
  for (const [providerId, rawProvider] of Object.entries(rawProviders)) {
    if ((0, _providerIdKaStHhRz.r)(providerId) !== "mistral" || !(0, _utilsD5DtWkEu.l)(rawProvider)) continue;
    const rawModels = rawProvider.models;
    if (!Array.isArray(rawModels)) continue;
    let modelsChanged = false;
    const nextModels = rawModels.map((model, index) => {
      if (!(0, _utilsD5DtWkEu.l)(model)) return model;
      const modelId = (0, _stringCoerceBUSzWgUA.s)(model.id) ?? "";
...
function resolveLegacyFetchConfig(raw) {
  ...
  const tools = (0, _utilsD5DtWkEu.l)(raw.tools) ? raw.tools : void 0;
  const web = (0, _utilsD5DtWkEu.l)(tools?.web) ? tools.web : void 0;
  return (0, _utilsD5DtWkEu.l)(web?.fetch) ? web.fetch : void 0;
}
function copyLegacyFirecrawlFetchConfig(fetch) {
  const current = fetch.firecrawl;
  if (!(0, _utilsD5DtWkEu.l)(current)) return;
...
function hasMappedLegacyWebFetchConfig(raw) {
  ...
  return (0, _utilsD5DtWkEu.l)(fetch.firecrawl);
}
function migratePluginWebFetchConfig(params) {
  ...
  const config = ensureRecord$2(entry, "config");
  const hadEnabled = entry.enabled !== void 0;
  const existing = (0, _utilsD5DtWkEu.l)(config.webFetch) ? cloneRecord$1(config.webFetch) : void 0;
  if (!hadEnabled) entry.enabled = true;
  if (!existing) {
...
function migrateLegacyWebFetchConfig(raw) {
  if (!(0, _utilsD5DtWkEu.l)(raw) || !hasMappedLegacyWebFetchConfig(raw)) return {
    config: raw,
    changes: []
  };
...
function normalizeLegacyWebFetchConfigRecord(raw) {
  ...
  for (const [key, value] of Object.entries(fetch)) {
    if (key === "firecrawl" && (0, _utilsD5DtWkEu.l)(value)) continue;
  ...
  if (hasOwnKey$1(fetch, "firecrawl")) changes.push("Removed empty tools.web.fetch.firecrawl.");
  return {
    config: nextRoot,
    changes
  };
...
function applyRuntimeLegacyConfigMigrations(raw) {
  ...
  if (changes.length === 0 || (0, _nodeUtil.isDeepStrictEqual)(next, original)) return {
    next: null,
    changes: []
  };
  return {
...
function canonicalizeAgentDir(agentDir) {
  ...
  if (process.platform === "darwin" || process.platform === "win32") return (0, _stringCoerceBUSzWgUA.i)(resolved);
  return resolved;
}
function collectReferencedAgentIds(cfg) {
  ...
  ids.add((0, _sessionKeyBh1lMwK.c)(defaultAgentId));
  for (const entry of agents) if (entry?.id) ids.add((0, _sessionKeyBh1lMwK.c)(entry.id));
  const bindings = cfg.bindings;
  if (Array.isArray(bindings)) for (const binding of bindings) {
    const id = binding?.agentId;
    if (typeof id === "string" && id.trim()) ids.add((0, _sessionKeyBh1lMwK.c)(id));
  }
  return [...ids];
}
function resolveEffectiveAgentDir(cfg, agentId, deps) {
  const id = (0, _sessionKeyBh1lMwK.c)(agentId);
  const trimmed = (Array.isArray(cfg.agents?.list) ? cfg.agents?.list.find((agent) => (0, _sessionKeyBh1lMwK.c)(agent.id) === id)?.agentDir : void 0)?.trim();
  if (trimmed) return (0, _utilsD5DtWkEu.m)(trimmed);
  const env = deps?.env ?? process.env;
  const root = (0, _pathsDvv9VRAc._)(env, deps?.homedir ?? (() => (0, _homeDirBEqRdfoa.o)(env, _nodeOs.default.homedir)));
...
function restoreEnvVarRefs(incoming, parsed, env = process.env) {
  ...
  if ((0, _utilsD5DtWkEu.x)(incoming) && (0, _utilsD5DtWkEu.x)(parsed)) {
    const result = {};
...
function resolveConfigAuditLogPath(env, homedir) {
  return _nodePath.default.join((0, _pathsDvv9VRAc._)(env, homedir), "logs", CONFIG_AUDIT_LOG_FILENAME);
}
...
function formatInvalidConfigDetails(issues) {
  return issues.map((issue) => `- ${(0, _safeTextBfEU6V1V.t)(issue.path || "<root>")}: ${(0, _safeTextBfEU6V1V.t)(issue.message)}`).join("\n");
}
...
function hasConfigMeta$1(value) {
  return (0, _utilsD5DtWkEu.l)(value) && (0, _utilsD5DtWkEu.l)(value.meta) && (typeof value.meta.lastTouchedVersion === "string" || typeof value.meta.lastTouchedAt === "string");
}
function resolveGatewayMode$1(value) {
  if (!(0, _utilsD5DtWkEu.l)(value) || !(0, _utilsD5DtWkEu.l)(value.gateway)) return null;
...
function resolveConfigHealthStatePath$1(env, homedir) {
  return _nodePath.default.join((0, _pathsDvv9VRAc._)(env, homedir), "logs", "config-health.json");
}
async function readConfigHealthState$1(deps) {
  try {
    ...
    return (0, _utilsD5DtWkEu.l)(parsed) ? parsed : {};
  } catch {
    return {};
  }
}
...
function getConfigHealthEntry$1(state, configPath) {
  ...
  if (!entries || !(0, _utilsD5DtWkEu.l)(entries)) return {};
  const entry = entries[configPath];
  return entry && (0, _utilsD5DtWkEu.l)(entry) ? entry : {};
}
...
function isUpdateChannelOnlyRoot$1(value) {
  ...
  if (!(0, _utilsD5DtWkEu.l)(update)) return false;
...
function createMergePatch(base, target) {
  if (!(0, _utilsD5DtWkEu.l)(base) || !(0, _utilsD5DtWkEu.l)(target)) return cloneUnknown(target);
  const patch = {};
  ...
  for (const key of keys) {
    ...
    if ((0, _utilsD5DtWkEu.l)(baseValue) && (0, _utilsD5DtWkEu.l)(targetValue)) {
      const childPatch = createMergePatch(baseValue, targetValue);
      if ((0, _utilsD5DtWkEu.l)(childPatch) && Object.keys(childPatch).length === 0) continue;
...
function projectSourceOntoRuntimeShape(source, runtime) {
  if (!(0, _utilsD5DtWkEu.l)(source) || !(0, _utilsD5DtWkEu.l)(runtime)) return cloneUnknown(source);
  const next = {};
...
function resolvePersistCandidateForWrite(params) {
  ...
  return (0, _schemaValidatorByqt0Q.i)(projectSourceOntoRuntimeShape(params.sourceConfig, params.runtimeConfig), patch);
}
...
function unsetPathForWriteAt(value, pathSegments, depth) {
  ...
  if ((0, _prototypeKeysCnLLLhBE.t)(segment) || !isWritePlainObject(value) || !hasOwnObjectKey(value, segment)) return {
    changed: false,
    value
  };
  if (isLeaf) {
...
function collectChangedPaths(base, target, path, output) {
  ...
  if ((0, _utilsD5DtWkEu.l)(base) && (0, _utilsD5DtWkEu.l)(target)) {
    const keys = new Set([...Object.keys(base), ...Object.keys(target)]);
    for (const key of keys) {
...
function normalizeExecSafeBinProfilesInConfig(cfg) {
  const normalizeExec = (exec) => {
    ...
    const normalizedProfiles = (0, _execSafeBinTrustBcrCYHRC.V)(typedExec.safeBinProfiles);
    typedExec.safeBinProfiles = Object.keys(normalizedProfiles).length > 0 ? normalizedProfiles : void 0;
    const normalizedTrustedDirs = (0, _execSafeBinTrustBcrCYHRC.i)(typedExec.safeBinTrustedDirs);
...
function normalizeStringValue(key, value) {
  ...
  if (!key) return value;
  if (PATH_KEY_RE.test(key) || PATH_LIST_KEYS.has(key)) return (0, _utilsD5DtWkEu.m)(value);
  return value;
}
function normalizeAny(key, value) {
  ...
  if (Array.isArray(value)) {
    ...
    return value.map((entry) => {
      ...
      if ((0, _utilsD5DtWkEu.x)(entry)) return normalizeAny(void 0, entry);
      return entry;
    });
  }
  if (!(0, _utilsD5DtWkEu.x)(value)) return value;
...
function parseConfigPath(raw) {
  ...
  if (parts.some((part) => (0, _prototypeKeysCnLLLhBE.t)(part))) return {
    ok: false,
...
function setConfigValueAtPath(root, path, value) {
  ...
  for (let idx = 0; idx < path.length - 1; idx += 1) {
    ...
    if (!(0, _utilsD5DtWkEu.x)(next)) cursor[key] = {};
    cursor = cursor[key];
  }
...
function unsetConfigValueAtPath(root, path) {
  ...
  for (let idx = 0; idx < path.length - 1; idx += 1) {
    const key = path[idx];
    const next = cursor[key];
    if (!(0, _utilsD5DtWkEu.x)(next)) return false;
    stack.push({
      node: cursor,
      key
    });
  ...
  for (let idx = stack.length - 1; idx >= 0; idx -= 1) {
    ...
    if ((0, _utilsD5DtWkEu.x)(child) && Object.keys(child).length === 0) delete node[key];else
    break;
  }
  return true;
}
function getConfigValueAtPath(root, path) {
  let cursor = root;
  for (const key of path) {
    if (!(0, _utilsD5DtWkEu.x)(cursor)) return;
    cursor = cursor[key];
  }
  return cursor;
}
...
function sanitizeOverrideValue(value, seen = /* @__PURE__ */new WeakSet()) {
  ...
  for (const [key, entry] of Object.entries(value)) {
    if (entry === void 0 || (0, _prototypeKeysCnLLLhBE.t)(key)) continue;
...
function mergeOverrides(base, override) {
  if (!(0, _utilsD5DtWkEu.x)(base) || !(0, _utilsD5DtWkEu.x)(override)) return override;
  const next = { ...base };
...
function resolveShellEnvExpectedKeys(env) {
  return [...new Set([
  ...(0, _providerEnvVarsSjBhOn.n)({ env }),
...
const GENERATED_BUNDLED_CHANNEL_CONFIG_METADATA = exports.T = [
{
...
function collectPatternCandidates(params) {
  ...
  if (token.kind === "wildcard") {
    ...
    if (!(0, _utilsD5DtWkEu.l)(params.current)) return;
...
function isObjectSecretRefCandidate(value) {
  ...
  return (0, _typesSecretsCeL3gSMO.i)(value) !== null;
}
...
function mapZodIssueToConfigIssue(issue) {
  ...
  const allowedValuesSummary = (0, _schemaValidatorByqt0Q.r)(collectAllowedValuesFromUnknownIssue(issue));
  ...
  return {
    path,
    message: (0, _schemaValidatorByqt0Q.n)(message, allowedValuesSummary),
...
function isWorkspaceAvatarPath(value, workspaceDir) {
  ...
  return (0, _avatarPolicyDEMOzJv.o)(workspaceRoot, _nodePath.default.resolve(workspaceRoot, value));
}
function validateIdentityAvatar(config) {
  ...
  for (const [index, entry] of agents.entries()) {
    ...
    if (!avatar) continue;
    if ((0, _avatarPolicyDEMOzJv.r)(avatar) || (0, _avatarPolicyDEMOzJv.i)(avatar)) continue;
    ...
    if ((0, _avatarPolicyDEMOzJv.n)(avatar) && !(0, _avatarPolicyDEMOzJv.c)(avatar)) {
      issues.push({
        path: `agents.list.${index}.identity.avatar`,
        message: "identity.avatar must be a workspace-relative path, http(s) URL, or data URI."
      });
    ...
    if (!isWorkspaceAvatarPath(avatar, (0, _agentScopeKFH9bkHi.b)(config, entry.id ?? (0, _agentScopeKFH9bkHi.x)(config)))) issues.push({
      path: `agents.list.${index}.identity.avatar`,
...
function validateGatewayTailscaleBind(config) {
  ...
  if (bindMode === "custom" && (0, _ipC5y47j8x.i)(customBindHost) && (0, _ipC5y47j8x.u)(customBindHost)) return [];
  return [{
    path: "gateway.bind",
...
function validateConfigObjectRaw(raw, opts) {
  ...
  const validated = _zodSchemaBO9ySEsE.t.safeParse(raw);
...
function validateConfigObjectWithPluginsBase(raw, opts) {
  ...
  const issues = [];
  const warnings = [];
  const hasExplicitPluginsConfig = (0, _utilsD5DtWkEu.l)(raw) && Object.prototype.hasOwnProperty.call(raw, "plugins");
  ...
  const ensureCompatPluginIds = () => {
    ...
    const workspaceDir = (0, _agentScopeKFH9bkHi.b)(config, (0, _agentScopeKFH9bkHi.x)(config));
    const overriddenBundledPluginIds = new Set((0, _manifestRegistryBd3A4lqx.t)({
      config,
    ...
    compatPluginIds = new Set((0, _manifestRegistryBd3A4lqx.r)({
      contract: "webSearchProviders",
      origin: "bundled",
      config,
      workspaceDir: workspaceDir ?? void 0,
  ...
  const ensureCompatConfig = () => {
    ...
    compatConfig = (0, _bundledCompatClStMMlW.t)({
      config,
  ...
  const ensureRegistry = () => {
    ...
    const registry = (0, _manifestRegistryBd3A4lqx.t)({
      ...
      workspaceDir: (0, _agentScopeKFH9bkHi.b)(effectiveConfig, (0, _agentScopeKFH9bkHi.x)(effectiveConfig)) ?? void 0,
      env: opts.env
    });
  ...
  const ensureNormalizedPlugins = () => {
    const info = ensureRegistry();
    if (!info.normalizedPlugins) info.normalizedPlugins = (0, _configStateCcN3bZ9D.a)(ensureCompatConfig().plugins);
  ...
  if (config.channels && (0, _utilsD5DtWkEu.l)(config.channels)) for (const key of Object.keys(config.channels)) {
  ...
  for (const channelId of _idsCYPyP4SY.t) heartbeatChannelIds.add((0, _stringCoerceBUSzWgUA.i)(channelId));
  const validateHeartbeatTarget = (target, path) => {
    ...
    if ((0, _idsCYPyP4SY.r)(trimmed)) return;
    if (!heartbeatChannelIds.has(normalized)) {
      const { registry } = ensureRegistry();
      for (const record of registry.plugins) for (const channelId of record.channels) {
        const pluginChannel = channelId.trim();
        if (pluginChannel) heartbeatChannelIds.add((0, _stringCoerceBUSzWgUA.i)(pluginChannel));
      }
    }
  ...
  if (entries && (0, _utilsD5DtWkEu.l)(entries)) {
  ...
  for (const pluginId of allow) {
    ...
    if (!knownIds.has(pluginId)) {
      const commandAlias = (0, _manifestCommandAliasesRuntimeDTknNvLF.t)({
        command: pluginId,
        registry
      });
  ...
  for (const record of registry.plugins) {
    ...
    if (enabled || entryHasConfig) if (record.configSchema) {
      const res = (0, _schemaValidatorByqt0Q.t)({
...
function parseOpenClawVersion(raw) {
  if (!raw) return null;
  const match = (0, _semverCompareB2EDRUg.r)(raw.trim()).match(VERSION_RE);
...
function compareOpenClawVersions(a, b) {
  ...
  if (parsedA.prerelease || parsedB.prerelease) return (0, _semverCompareB2EDRUg.n)(parsedA.prerelease, parsedB.prerelease);
  return 0;
}
...
async function tightenStateDirPermissionsIfNeeded(params) {
  ...
  const stateDir = (0, _pathsDvv9VRAc._)(params.env, params.homedir);
...
function hasConfigMeta(value) {
  ...
  return (0, _utilsD5DtWkEu.l)(meta);
}
function resolveGatewayMode(value) {
  if (!(0, _utilsD5DtWkEu.l)(value)) return null;
  const gateway = value.gateway;
  if (!(0, _utilsD5DtWkEu.l)(gateway) || typeof gateway.mode !== "string") return null;
  const trimmed = gateway.mode.trim();
  return trimmed.length > 0 ? trimmed : null;
}
function collectEnvRefPaths(value, path, output) {
  if (typeof value === "string") {
    if ((0, _envSubstitution3wGlQjxu.n)(value)) output.set(path, value);
    return;
  }
  if (Array.isArray(value)) {
  ...
  if ((0, _utilsD5DtWkEu.l)(value)) for (const [key, child] of Object.entries(value)) collectEnvRefPaths(child, path ? `${path}.${key}` : key, output);
}
function resolveConfigHealthStatePath(env, homedir) {
  return _nodePath.default.join((0, _pathsDvv9VRAc._)(env, homedir), "logs", CONFIG_HEALTH_STATE_FILENAME);
}
...
function stampConfigVersion(cfg) {
  ...
  return {
    ...
    meta: {
      ...cfg.meta,
      lastTouchedVersion: _versionBk5OWRN.n,
      lastTouchedAt: now
    }
  };
}
function warnIfConfigFromFuture(cfg, logger) {
  ...
  if (!touched) return;
  if (shouldWarnOnTouchedVersion(_versionBk5OWRN.n, touched)) logger.warn(`Config was last written by a newer OpenClaw (${touched}); current version is ${_versionBk5OWRN.n}.`);
}
function resolveConfigPathForDeps(deps) {
  if (deps.configPath) return deps.configPath;
  return (0, _pathsDvv9VRAc.o)(deps.env, (0, _pathsDvv9VRAc._)(deps.env, deps.homedir));
}
function normalizeDeps(overrides = {}) {
  return {
    ...
    homedir: overrides.homedir ?? (() => (0, _homeDirBEqRdfoa.o)(overrides.env ?? process.env, _nodeOs.default.homedir)),
...
function resolveConfigIncludesForRead(parsed, configPath, deps) {
  return (0, _includesDnSQeTaA.a)(parsed, configPath, {
    readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
    readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesDnSQeTaA.i)({
      includePath,
      resolvedPath,
      rootRealDir,
      ioFs: deps.fs
...
function resolveConfigForRead(resolvedIncludes, env) {
  if (resolvedIncludes && typeof resolvedIncludes === "object" && "env" in resolvedIncludes) (0, _stateDirDotenvCh7ZMbTt.r)(resolvedIncludes, env);
  const envWarnings = [];
  return {
    resolvedConfigRaw: (0, _envSubstitution3wGlQjxu.r)(resolvedIncludes, env, { onMissing: (w) => envWarnings.push(w) }),
...
function createConfigIO(overrides = {}) {
  ...
  function finalizeLoadedRuntimeConfig(cfg) {
    ...
    (0, _stateDirDotenvCh7ZMbTt.r)(cfg, deps.env);
    if (((0, _shellEnvDTnWMCId.o)(deps.env) || cfg.env?.shellEnv?.enabled === true) && !(0, _shellEnvDTnWMCId.a)(deps.env)) (0, _shellEnvDTnWMCId.r)({
      enabled: true,
      env: deps.env,
      expectedKeys: resolveShellEnvExpectedKeys(deps.env),
      logger: deps.logger,
      timeoutMs: cfg.env?.shellEnv?.timeoutMs ?? (0, _shellEnvDTnWMCId.i)(deps.env)
    });
    const pendingSecret = AUTO_OWNER_DISPLAY_SECRET_BY_PATH.get(configPath);
    const ownerDisplaySecretResolution = (0, _ownerDisplayCR4JL3B.t)(cfg, () => pendingSecret ?? _nodeCrypto.default.randomBytes(32).toString("hex"));
  ...
  function loadConfig() {
    try {
      ...
      if (!deps.fs.existsSync(configPath)) {
        if ((0, _shellEnvDTnWMCId.o)(deps.env) && !(0, _shellEnvDTnWMCId.a)(deps.env)) (0, _shellEnvDTnWMCId.r)({
          enabled: true,
          env: deps.env,
          expectedKeys: resolveShellEnvExpectedKeys(deps.env),
          logger: deps.logger,
          timeoutMs: (0, _shellEnvDTnWMCId.i)(deps.env)
        });
        return {};
      }
      ...
      if (validated.warnings.length > 0) {
        const details = validated.warnings.map((iss) => `- ${(0, _safeTextBfEU6V1V.t)(iss.path || "<root>")}: ${(0, _safeTextBfEU6V1V.t)(iss.message)}`).join("\n");
  ...
  async function readConfigFileSnapshotInternal() {
    ...
    try {
      ...
      try {
        ...
        const message = err instanceof _includesDnSQeTaA.n ? err.message : `Include resolution failed: ${String(err)}`;
  ...
  async function writeConfigFile(cfg, options = {}) {
    ...
    if (snapshot.valid && snapshot.exists) {
      ...
      try {
        const resolvedIncludes = (0, _includesDnSQeTaA.a)(snapshot.parsed, configPath, {
          readFile: (candidate) => deps.fs.readFileSync(candidate, "utf-8"),
          readFileWithGuards: ({ includePath, resolvedPath, rootRealDir }) => (0, _includesDnSQeTaA.i)({
            includePath,
            resolvedPath,
...
function registerConfigWriteListener(listener) {
  return (0, _runtimeSnapshotBwqEmc6G.c)(listener);
}
...
function projectConfigOntoRuntimeSourceSnapshot(config) {
  const runtimeConfigSnapshot = (0, _runtimeSnapshotBwqEmc6G.r)();
  const runtimeConfigSourceSnapshot = (0, _runtimeSnapshotBwqEmc6G.a)();
  ...
  return coerceConfig((0, _schemaValidatorByqt0Q.i)(coerceConfig(projectSourceOntoRuntimeShape(runtimeConfigSourceSnapshot, runtimeConfigSnapshot)), createMergePatch(runtimeConfigSnapshot, config)));
}
function loadConfig() {
  return (0, _runtimeSnapshotBwqEmc6G.o)(() => createConfigIO().loadConfig());
}
...
async function writeConfigFile(cfg, options = {}) {
  ...
  if (hadBothSnapshots) nextCfg = coerceConfig((0, _schemaValidatorByqt0Q.i)(runtimeConfigSourceSnapshot, createMergePatch(runtimeConfigSnapshot, cfg)));
  ...
  if (options.skipRuntimeSnapshotRefresh && !hadRuntimeSnapshot && !(0, _runtimeSnapshotBwqEmc6G.i)()) return;
  const notifyCommittedWrite = () => {
    const currentRuntimeConfig = (0, _runtimeSnapshotBwqEmc6G.r)();
    if (!currentRuntimeConfig) return;
    (0, _runtimeSnapshotBwqEmc6G.s)({
  ...
  await (0, _runtimeSnapshotBwqEmc6G.n)({
    nextSourceConfig: nextCfg,
    hadRuntimeSnapshot,
    hadBothSnapshots,
    loadFreshConfig: () => io.loadConfig(),
    notifyCommittedWrite,
    formatRefreshError: (error) => (0, _errorsD8p6rxH.i)(error),
