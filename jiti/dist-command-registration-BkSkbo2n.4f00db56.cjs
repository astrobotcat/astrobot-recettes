"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = clearPluginCommands;exports.c = listProviderPluginCommandSpecs;exports.i = validatePluginCommandDefinition;exports.l = void 0;exports.n = registerPluginCommand;exports.o = clearPluginCommandsForPlugin;exports.r = validateCommandName;exports.s = getPluginCommandSpecs;exports.t = listPluginInvocationKeys;exports.u = setPluginCommandRegistryLocked;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
const getState = () => (0, _globalSingletonB80lDOJ.n)(PLUGIN_COMMAND_STATE_KEY, () => ({
  pluginCommands: /* @__PURE__ */new Map(),
  registryLocked: false
}));
const getPluginCommandMap = () => getState().pluginCommands;
const pluginCommands = exports.l = new Proxy(/* @__PURE__ */new Map(), { get(_target, property) {
...
function resolvePluginNativeName(command, provider) {
  const providerName = (0, _stringCoerceBUSzWgUA.o)(provider);
...
function getPluginCommandSpecs(provider) {
  const providerName = (0, _stringCoerceBUSzWgUA.o)(provider);
  if (providerName && (0, _registryDelpa74L.t)(providerName)?.commands?.nativeCommandsAutoEnabled !== true) return [];
...
function registerPluginCommand(pluginId, command, opts) {
  ...
  const key = `/${(0, _stringCoerceBUSzWgUA.i)(name)}`;
  ...
  (0, _globalsDe6QTwLG.r)(`Registered plugin command: ${key} (plugin: ${pluginId})`);
  return { ok: true };
}
//#endregion /* v9-218270b9829a5c3d */
