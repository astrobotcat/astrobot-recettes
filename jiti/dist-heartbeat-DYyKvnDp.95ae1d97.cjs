"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = parseHeartbeatTasks;exports.i = isTaskDue;exports.n = void 0;exports.o = resolveHeartbeatPrompt;exports.r = isHeartbeatContentEffectivelyEmpty;exports.s = stripHeartbeatToken;exports.t = void 0;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function resolveHeartbeatPrompt(raw) {
  return ((0, _stringCoerceBUSzWgUA.s)(raw) ?? "") || "Read HEARTBEAT.md if it exists (workspace context). Follow it strictly. Do not infer or repeat old tasks from prior chats. If nothing needs attention, reply HEARTBEAT_OK.";
}
function stripTokenAtEdges(raw) {
  ...
  const token = _tokensCKM4Lddu.t;
  const tokenAtEndWithOptionalTrailingPunctuation = new RegExp(`${(0, _utilsD5DtWkEu.c)(token)}[^\\w]{0,4}$`);
...
function isTaskDue(lastRunMs, interval, nowMs) {
  ...
  try {
    const intervalMs = (0, _parseDurationDHL2gXIv.t)(interval, { defaultUnit: "m" });
    return nowMs - lastRunMs >= intervalMs;
  } catch {
    return false;
  }
}
//#endregion /* v9-f859e45cfeb52481 */
