"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = setAbortMemory;exports.n = isAbortRequestText;exports.r = isAbortTrigger;exports.t = getAbortMemory;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function normalizeAbortTriggerText(text) {
  return (0, _stringCoerceBUSzWgUA.i)(text).replace(/[’`]/g, "'").replace(/\s+/g, " ").replace(TRAILING_ABORT_PUNCTUATION_RE, "").trim();
}
...
function isAbortRequestText(text, options) {
  ...
  const normalizedLower = (0, _stringCoerceBUSzWgUA.i)(normalized);
