"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveGatewayBindUrl;exports.t = resolveTailnetHostWithRunner;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function resolveGatewayBindUrl(params) {
  ...
  if (bind === "custom") {
    const host = (0, _stringCoerceBUSzWgUA.s)(params.customBindHost);
    if (host) return {
...
function parsePossiblyNoisyStatus(raw) {
  ...
  return (0, _zodParseEztZP0fF.t)(TailscaleStatusSchema, raw.slice(start, end + 1));
}
