"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = setPathExistingStrict;exports.n = getPath;exports.r = setPathCreateStrict;exports.t = deletePathStrict;var _utilsD5DtWkEu = require("./utils-D5DtWkEu.js");
...
function traverseToLeafParent(params) {
  ...
  for (let index = 0; index < params.segments.length - 1; index += 1) {
    ...
    if (!(0, _utilsD5DtWkEu.l)(cursor)) throw new Error(`Invalid path shape at ${params.segments.slice(0, index).join(".") || "<root>"}.`);
...
function getPath(root, segments) {
  ...
  for (const segment of segments) {
    ...
    if (!(0, _utilsD5DtWkEu.l)(cursor)) return;
    cursor = cursor[segment];
  }
  return cursor;
}
function setPathCreateStrict(root, segments, value) {
  ...
  for (let index = 0; index < segments.length - 1; index += 1) {
    ...
    if (Array.isArray(cursor)) {
      ...
      if (existing === void 0 || existing === null) {
        ...
        changed = true;
      } else if (needs === "array" ? !Array.isArray(existing) : !(0, _utilsD5DtWkEu.l)(existing)) throw new Error(`Invalid path shape at ${segments.slice(0, index + 1).join(".")}.`);
      cursor = cursor[arrayIndex];
      continue;
    }
    if (!(0, _utilsD5DtWkEu.l)(cursor)) throw new Error(`Invalid path shape at ${segments.slice(0, index).join(".") || "<root>"}.`);
  ...
  if (!(0, _utilsD5DtWkEu.l)(cursor)) throw new Error(`Invalid path shape at ${segments.slice(0, -1).join(".") || "<root>"}.`);
