"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = sendPayloadMediaSequenceAndFinalize;exports.a = formatTextWithAttachmentLinks;exports.b = sendTextMediaPayload;exports.c = hasOutboundText;exports.d = resolveOutboundMediaUrls;exports.f = resolvePayloadMediaUrls;exports.g = sendPayloadMediaSequence;exports.h = sendMediaWithLeadingCaption;exports.i = deliverTextOrMediaReply;exports.l = isNumericTargetId;exports.m = resolveTextChunksWithFallback;exports.n = createNormalizedOutboundDeliverer;exports.o = hasOutboundMedia;exports.p = resolveSendableOutboundReplyParts;exports.r = deliverFormattedTextWithAttachments;exports.s = hasOutboundReplyContent;exports.t = countOutboundMedia;exports.u = normalizeOutboundReplyPayload;exports.v = sendPayloadMediaSequenceOrFallback;exports.x = buildMediaPayload;exports.y = sendPayloadWithChunkedTextAndMedia;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function normalizeOutboundReplyPayload(payload) {
  return {
    text: (0, _stringCoerceBUSzWgUA.d)(payload.text),
    mediaUrls: Array.isArray(payload.mediaUrls) ? payload.mediaUrls.filter((entry) => typeof entry === "string" && entry.length > 0) : void 0,
    mediaUrl: (0, _stringCoerceBUSzWgUA.d)(payload.mediaUrl),
    replyToId: (0, _stringCoerceBUSzWgUA.d)(payload.replyToId)
  };
}
