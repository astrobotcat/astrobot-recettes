"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = resolveTaggedReasoningOutputMode;exports.a = buildProviderReplayFamilyHooks;exports.c = cloneFirstTemplateModel;exports.d = buildGoogleGeminiReplayPolicy;exports.f = buildHybridAnthropicOrOpenAIReplayPolicy;exports.g = buildStrictAnthropicReplayPolicy;exports.h = buildPassthroughGeminiSanitizingReplayPolicy;exports.i = void 0;exports.l = matchesExactOrPrefix;exports.m = buildOpenAICompatibleReplayPolicy;exports.n = void 0;exports.o = getModelProviderHint;exports.p = buildNativeAnthropicReplayPolicyForModel;exports.r = void 0;exports.s = isProxyReasoningUnsupportedModelHint;exports.t = void 0;exports.u = buildAnthropicReplayPolicyForModel;exports.v = sanitizeGoogleGeminiReplayHistory;exports.y = shouldPreserveThinkingBlocks;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
require("./provider-attribution-BJhkfmfB.js");
var _providerModelCompatDsxuyzi = require("./provider-model-compat-Dsxuyzi4.js");
require("./moonshot-thinking-stream-wrappers-B057G_9z.js");
...
function shouldPreserveThinkingBlocks(modelId) {
  const id = (0, _stringCoerceBUSzWgUA.i)(modelId);
...
function buildAnthropicReplayPolicyForModel(modelId) {
  return buildStrictAnthropicReplayPolicy({ dropThinkingBlocks: (0, _stringCoerceBUSzWgUA.i)(modelId).includes("claude") && !shouldPreserveThinkingBlocks(modelId) });
}
function buildNativeAnthropicReplayPolicyForModel(modelId) {
  return buildStrictAnthropicReplayPolicy({
    dropThinkingBlocks: (0, _stringCoerceBUSzWgUA.i)(modelId).includes("claude") && !shouldPreserveThinkingBlocks(modelId),
    sanitizeToolCallIds: true,
...
function buildHybridAnthropicOrOpenAIReplayPolicy(ctx, options = {}) {
  if (ctx.modelApi === "anthropic-messages" || ctx.modelApi === "bedrock-converse-stream") {
    const isClaude = (0, _stringCoerceBUSzWgUA.i)(ctx.modelId).includes("claude");
...
function buildPassthroughGeminiSanitizingReplayPolicy(modelId) {
  return {
    ...
    validateGeminiTurns: false,
    validateAnthropicTurns: false,
    ...((0, _stringCoerceBUSzWgUA.i)(modelId).includes("gemini") ? { sanitizeThoughtSignatures: {
        allowBase64Only: true,
        includeCamelCase: true
      } } : {})
  };
...
function matchesExactOrPrefix(id, values) {
  const normalizedId = (0, _stringCoerceBUSzWgUA.i)(id);
  return values.some((value) => {
    const normalizedValue = (0, _stringCoerceBUSzWgUA.i)(value);
...
function cloneFirstTemplateModel(params) {
  ...
  for (const templateId of [...new Set(params.templateIds)].filter(Boolean)) {
    ...
    return (0, _providerModelCompatDsxuyzi.i)({
      ...template,
      id: trimmedModelId,
      name: trimmedModelId,
      ...params.patch
...
function getModelProviderHint(modelId) {
  const trimmed = (0, _stringCoerceBUSzWgUA.o)(modelId);
