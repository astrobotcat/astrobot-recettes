"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveToolCallArgumentsEncoding;exports.i = normalizeModelCompat;exports.n = hasNativeWebSearchTool;exports.o = resolveUnsupportedToolSchemaKeywords;exports.r = hasToolSchemaProfile;exports.s = detectOpenAICompletionsCompat;exports.t = applyModelCompatPatch;var _providerAttributionBJhkfmfB = require("./provider-attribution-BJhkfmfB.js");
...
function resolveOpenAICompletionsCompatDefaults(input) {
  ...
  return {
    ...
    supportsUsageInStreaming: provider === "ollama" || !isNonStandard && (!usesConfiguredNonOpenAIEndpoint || supportsNativeStreamingUsageCompat),
