"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveChannelEntryMatchWithFallback;exports.i = resolveChannelEntryMatch;exports.n = buildChannelKeyCandidates;exports.o = resolveChannelMatchConfig;exports.r = normalizeChannelSlug;exports.s = resolveNestedAllowlistDecision;exports.t = applyChannelMatchMeta;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function normalizeChannelSlug(value) {
  return (0, _stringCoerceBUSzWgUA.i)(value).replace(/^#/, "").replace(/[^a-z0-9]+/g, "-").replace(/^-+|-+$/g, "");
}
