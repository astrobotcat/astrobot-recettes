"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resetGlobalHookRunner;exports.i = initializeGlobalHookRunner;exports.n = getGlobalPluginRegistry;exports.o = runGlobalGatewayStopSafely;exports.r = hasGlobalHooks;exports.s = joinPresentTextSegments;exports.t = getGlobalHookRunner;var _errorsD8p6rxH = require("./errors-D8p6rxH8.js");
...
function createHookRunner(registry, options = {}) {
  ...
  const sanitizeHookError = (error) => {
    return (0, _errorsD8p6rxH.i)(error).split("\n")[0]?.trim() || "unknown error";
  };
...
const getState = () => (0, _globalSingletonB80lDOJ.n)(hookRunnerGlobalStateKey, () => ({
  hookRunner: null,
  registry: null
}));
const getLog = () => (0, _subsystemCgmckbux.t)("plugins");
/**
