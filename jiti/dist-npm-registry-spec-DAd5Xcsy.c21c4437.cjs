"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = validateRegistryNpmSpec;exports.n = isPrereleaseResolutionAllowed;exports.r = parseRegistryNpmSpec;exports.t = formatPrereleaseResolutionError;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function isPrereleaseResolutionAllowed(params) {
  ...
  return (0, _stringCoerceBUSzWgUA.i)(params.spec.selector) !== "latest";
}
function formatPrereleaseResolutionError(params) {
  const selectorHint = params.spec.selectorKind === "none" || (0, _stringCoerceBUSzWgUA.i)(params.spec.selector) === "latest" ? `Use "${params.spec.name}@beta" (or another prerelease tag) or an exact prerelease version to opt in explicitly.` : `Use an explicit prerelease tag or exact prerelease version if you want prerelease installs.`;
