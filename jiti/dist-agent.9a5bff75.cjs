"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.Agent = void 0;var _piAi = require("@mariozechner/pi-ai");
...
class Agent {
  ...
  constructor(options = {}) {
    ...
    this.streamFn = options.streamFn ?? _piAi.streamSimple;
  ...
  async runPromptMessages(messages, options = {}) {
    await this.runWithLifecycle(async (signal) => {
      await (0, _agentLoop.runAgentLoop)(messages, this.createContextSnapshot(), this.createLoopConfig(options), (event) => this.processEvents(event), signal, this.streamFn);
    });
  }
  async runContinuation() {
    await this.runWithLifecycle(async (signal) => {
      await (0, _agentLoop.runAgentLoopContinue)(this.createContextSnapshot(), this.createLoopConfig(), (event) => this.processEvents(event), signal, this.streamFn);
    });
  }
...
}exports.Agent = Agent; /* v9-65f6388ecaea2008 */
