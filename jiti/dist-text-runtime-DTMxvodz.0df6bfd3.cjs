"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = isAutoLinkedFileRef;exports.i = void 0;exports.n = chunkItems;exports.o = renderMarkdownIRChunksWithinLimit;exports.r = stripMarkdown;exports.t = resolveReactionLevel;require("./redact-D4nea1HF.js");
var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
require("./logger-D8OnBgBc.js");
require("./utils-D5DtWkEu.js");
require("./logger-BA_TvTc6.js");
require("./safe-text-BfEU6V1V.js");
require("./diagnostic-C-cec-ak.js");
var _tablesD6dozHvf = require("./tables-D6dozHvf.js");
...
function renderMarkdownIRChunksWithinLimit(options) {
  ...
  const pending = (0, _tablesD6dozHvf.r)(options.ir, normalizedLimit);
  const finalized = [];
...
function splitMarkdownIRByRenderedLimit(chunk, renderedLimit, options) {
  ...
  return [(0, _tablesD6dozHvf.o)(chunk, 0, splitLimit), (0, _tablesD6dozHvf.o)(chunk, splitLimit, currentTextLength)];
}
function findLargestChunkTextLengthWithinRenderedLimit(chunk, renderedLimit, options) {
  ...
  for (let candidateLength = currentTextLength - 1; candidateLength >= 1; candidateLength -= 1) {
    const candidate = (0, _tablesD6dozHvf.o)(chunk, 0, candidateLength);
...
function splitMarkdownIRPreserveWhitespace(ir, limit) {
  ...
  while (cursor < ir.text.length) {
    ...
    chunks.push((0, _tablesD6dozHvf.o)(ir, cursor, end));
    cursor = end;
  }
  return chunks;
}
...
function coalesceWhitespaceOnlyMarkdownIRChunks(chunks, renderedLimit, options) {
  ...
  while (index < chunks.length) {
    ...
    if (prev && next) for (let prefixLength = chunkLength - 1; prefixLength >= 1; prefixLength -= 1) {
      const prefix = (0, _tablesD6dozHvf.o)(chunk, 0, prefixLength);
      const suffix = (0, _tablesD6dozHvf.o)(chunk, prefixLength, chunkLength);
...
const FILE_REF_EXTENSIONS_WITH_TLD = exports.i = new Set([
"md",
"go",
"py",
"pl",
...
function isAutoLinkedFileRef(href, label) {
  ...
  const ext = (0, _stringCoerceBUSzWgUA.i)(label.slice(dotIndex + 1));
