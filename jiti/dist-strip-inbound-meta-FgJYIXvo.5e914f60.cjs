"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = stripInboundMetadata;exports.r = stripLeadingInboundMetadata;exports.t = extractInboundSenderLabel;var _zodParseEztZP0fF = require("./zod-parse-EztZP0fF.js");
...
const InboundMetaBlockSchema = _zod.z.record(_zod.z.string(), _zod.z.unknown());
...
function parseInboundMetaBlock(lines, sentinel) {
  for (let i = 0; i < lines.length; i++) {
    ...
    const parsed = (0, _zodParseEztZP0fF.t)(InboundMetaBlockSchema, jsonText);
