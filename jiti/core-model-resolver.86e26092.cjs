"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.defaultModelPerProvider = void 0;exports.findExactModelReferenceMatch = findExactModelReferenceMatch;exports.findInitialModel = findInitialModel;exports.parseModelPattern = parseModelPattern;exports.resolveCliModel = resolveCliModel;exports.resolveModelScope = resolveModelScope;exports.restoreModelFromSession = restoreModelFromSession;
...
async function findInitialModel(options) {
  ...
  if (cliProvider && cliModel) {
    ...
    if (resolved.error) {
      console.error(_chalk.default.red(resolved.error));
      process.exit(1);
    }
    if (resolved.model) {
      return { model: resolved.model, thinkingLevel: _defaults.DEFAULT_THINKING_LEVEL, fallbackMessage: undefined };
    }
  }
