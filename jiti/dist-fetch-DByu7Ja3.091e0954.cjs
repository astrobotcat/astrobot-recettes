"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = wrapFetchWithAbortSignal;exports.t = resolveFetch;var _fetchTimeoutDZD6CQL_ = require("./fetch-timeout-DZD6CQL_.js");
...
function wrapFetchWithAbortSignal(fetchImpl) {
  ...
  const wrapped = (input, init) => {
    ...
    const onAbort = (0, _fetchTimeoutDZD6CQL_.t)(controller);
