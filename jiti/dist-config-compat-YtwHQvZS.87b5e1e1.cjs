"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = migrateMemoryWikiLegacyConfig;exports.r = normalizeCompatibilityConfig;exports.t = void 0; //#region extensions/memory-wiki/src/config-compat.ts
...
const legacyConfigRules = exports.t = [{
  path: [
  "plugins",
  "entries",
  "memory-wiki",
