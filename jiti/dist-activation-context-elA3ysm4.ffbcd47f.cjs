"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = resolveBundledPluginCompatibleLoadValues;exports.r = withActivatedPluginIds;exports.t = resolveBundledPluginCompatibleActivationInputs;var _bundledCompatClStMMlW = require("./bundled-compat-ClStMMlW.js");
...
function applyPluginCompatibilityOverrides(params) {
  const allowlistCompat = params.compat?.allowlistPluginIds?.length ? (0, _bundledCompatClStMMlW.t)({
    config: params.config,
    pluginIds: params.compat.allowlistPluginIds
  }) : params.config;
  const enablementCompat = params.compat?.enablementPluginIds?.length ? (0, _bundledCompatClStMMlW.n)({
    config: allowlistCompat,
    pluginIds: params.compat.enablementPluginIds
  }) : allowlistCompat;
  return params.compat?.vitestPluginIds?.length ? (0, _bundledCompatClStMMlW.r)({
...
function resolvePluginActivationSnapshot(params) {
  ...
  return {
    ...
    normalized: (0, _configStateCcN3bZ9D.a)(resolvedConfig?.plugins),
    activationSourceConfig: rawConfig,
    activationSource: (0, _configStateCcN3bZ9D.n)({ config: rawConfig }),
...
function resolvePluginActivationInputs(params) {
  ...
  return {
    ...
    config,
    normalized: (0, _configStateCcN3bZ9D.a)(config?.plugins),
