"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = note$1;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function wrapLine(line, maxWidth) {
  ...
  const firstWidth = Math.max(10, maxWidth - (0, _ansiBs_ZZlnS.i)(firstPrefix));
  const nextWidth = Math.max(10, maxWidth - (0, _ansiBs_ZZlnS.i)(nextPrefix));
  ...
  for (const word of words) {
    if (!current) {
      if ((0, _ansiBs_ZZlnS.i)(word) > available) {
    ...
    if ((0, _ansiBs_ZZlnS.i)(candidate) <= available) {
      current = candidate;
      continue;
    }
...
function note$1(message, title) {
  ...
  (0, _prompts.note)(wrapNoteMessage(message), (0, _promptStyleBRivICXb.r)(title));
}
//#endregion /* v9-8c1eef030f72a873 */
