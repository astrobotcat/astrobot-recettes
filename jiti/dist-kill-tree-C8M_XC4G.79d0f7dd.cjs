"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = killProcessTree;var _nodeChild_process = require("node:child_process");
...
function runTaskkill(args) {
  try {
    (0, _nodeChild_process.spawn)("taskkill", args, {
      stdio: "ignore",
      detached: true,
      windowsHide: true
    });
