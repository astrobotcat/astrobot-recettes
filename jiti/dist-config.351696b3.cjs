...
// Package Detection
// =============================================================================
const _filename = (0, _url.fileURLToPath)("file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/config.js");
const _dirname = (0, _path.dirname)(_filename);
/**
 * Detect if we're running as a Bun compiled binary.
 * Bun binaries have import.meta.url containing "$bunfs", "~BUN", or "%7EBUN" (Bun's virtual filesystem path)
 */
const isBunBinary = exports.isBunBinary = "file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/config.js".includes("$bunfs") || "file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/config.js".includes("~BUN") || "file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/node_modules/@mariozechner/pi-coding-agent/dist/config.js".includes("%7EBUN");
...
function detectInstallMethod() {
  ...
  const resolvedPath = `${_dirname}\0${process.execPath || ""}`.toLowerCase();
...
function getInteractiveAssetsDir() {
  if (isBunBinary) {
    return (0, _path.join)((0, _path.dirname)(process.execPath), "assets");
  }
  const packageDir = getPackageDir();
  const srcOrDist = (0, _fs.existsSync)((0, _path.join)(packageDir, "src")) ? "src" : "dist";
