"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.asObjectRecord = asObjectRecord;Object.defineProperty(exports, "collectProviderDangerousNameMatchingScopes", { enumerable: true, get: function () {return _dangerousNameMatchingC88BNn_A.t;} });Object.defineProperty(exports, "detectPluginInstallPathIssue", { enumerable: true, get: function () {return _pluginInstallPathWarningsDcDQdIb.t;} });Object.defineProperty(exports, "formatPluginInstallPathIssue", { enumerable: true, get: function () {return _pluginInstallPathWarningsDcDQdIb.n;} });exports.hasLegacyAccountStreamingAliases = hasLegacyAccountStreamingAliases;exports.hasLegacyStreamingAliases = hasLegacyStreamingAliases;exports.normalizeLegacyDmAliases = normalizeLegacyDmAliases;exports.normalizeLegacyStreamingAliases = normalizeLegacyStreamingAliases;Object.defineProperty(exports, "removePluginFromConfig", { enumerable: true, get: function () {return _uninstallZvkoimDi.t;} });var _stringNormalizationXm3f27dv = require("../string-normalization-xm3f27dv.js");
var _dangerousNameMatchingC88BNn_A = require("../dangerous-name-matching-C88BNn_A.js");
var _pluginInstallPathWarningsDcDQdIb = require("../plugin-install-path-warnings-DcDQdIb1.js");
var _uninstallZvkoimDi = require("../uninstall-ZvkoimDi.js");
...
function allowFromListsMatch(left, right) {
  ...
  const normalizedLeft = (0, _stringNormalizationXm3f27dv.s)(left);
  const normalizedRight = (0, _stringNormalizationXm3f27dv.s)(right);
...
function normalizeLegacyStreamingAliases(params) {
  ...
  if ((hadLegacyStreamMode || typeof beforeStreaming === "boolean" || typeof beforeStreaming === "string") && streaming.mode === void 0) {
    ...
    if (hadLegacyStreamMode) params.changes.push(`Moved ${params.pathPrefix}.streamMode → ${params.pathPrefix}.streaming.mode (${params.resolvedMode}).`);else
    if (typeof beforeStreaming === "boolean") params.changes.push(`Moved ${params.pathPrefix}.streaming (boolean) → ${params.pathPrefix}.streaming.mode (${params.resolvedMode}).`);else
    if (typeof beforeStreaming === "string") params.changes.push(`Moved ${params.pathPrefix}.streaming (scalar) → ${params.pathPrefix}.streaming.mode (${params.resolvedMode}).`);
    changed = true;
  }
