"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.n = shouldIgnoreWarning;exports.t = installProcessWarningFilter;var _globalSingletonB80lDOJ = require("./global-singleton-B80lD-oJ.js");
...
function installProcessWarningFilter() {
  const state = (0, _globalSingletonB80lDOJ.n)(warningFilterKey, () => ({ installed: false }));
