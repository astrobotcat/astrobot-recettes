"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = createAuthRateLimiter;exports.n = exports.i = void 0;exports.o = normalizeRateLimitClientIp;exports.t = exports.r = void 0;var _netLBInRHnX = require("./net-lBInRHnX.js");
...
*/
const AUTH_RATE_LIMIT_SCOPE_DEFAULT = exports.t = "default";
const AUTH_RATE_LIMIT_SCOPE_SHARED_SECRET = exports.i = "shared-secret";
const AUTH_RATE_LIMIT_SCOPE_DEVICE_TOKEN = exports.n = "device-token";
const AUTH_RATE_LIMIT_SCOPE_HOOK_AUTH = exports.r = "hook-auth";
...
function normalizeRateLimitClientIp(ip) {
  ...
  return (0, _netLBInRHnX.p)({ remoteAddr: ip }) ?? "unknown";
}
function createAuthRateLimiter(config) {
  ...
  function isExempt(ip) {
    return exemptLoopback && (0, _netLBInRHnX.i)(ip);
  }
