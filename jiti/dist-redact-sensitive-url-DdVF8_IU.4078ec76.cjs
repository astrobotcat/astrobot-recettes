"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = redactSensitiveUrlLikeString;exports.i = redactSensitiveUrl;exports.n = hasSensitiveUrlHintTag;exports.r = isSensitiveUrlConfigPath;exports.t = void 0;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
//#region src/shared/net/redact-sensitive-url.ts
const SENSITIVE_URL_HINT_TAG = exports.t = "url-secret";
...
function isSensitiveUrlQueryParamName(name) {
  return SENSITIVE_URL_QUERY_PARAM_NAMES.has((0, _stringCoerceBUSzWgUA.i)(name));
}
