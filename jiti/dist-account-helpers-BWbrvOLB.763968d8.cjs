"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = mergeAccountConfig;exports.i = listCombinedAccountIds;exports.n = describeAccountSnapshot;exports.o = resolveListedDefaultAccountId;exports.r = describeWebhookAccountSnapshot;exports.s = resolveMergedAccountConfig;exports.t = createAccountListHelpers;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function createAccountListHelpers(channelKey, options) {
  function resolveConfiguredDefaultAccountId(cfg) {
    ...
    const preferred = (0, _accountIdJ7GeQlaZ.r)(typeof channel?.defaultAccount === "string" ? channel.defaultAccount : void 0);
    if (!preferred) return;
    const ids = listAccountIds(cfg);
    if (options?.allowUnlistedDefaultAccount) return preferred;
    if (ids.some((id) => (0, _accountIdJ7GeQlaZ.n)(id) === preferred)) return preferred;
  }
  ...
  function listAccountIds(cfg) {
    return listCombinedAccountIds({
      ...
      fallbackAccountIdWhenEmpty: _accountIdJ7GeQlaZ.t
    });
  }
...
function resolveListedDefaultAccountId(params) {
  ...
  const normalizeListedAccountId = params.normalizeListedAccountId ?? _accountIdJ7GeQlaZ.n;
  ...
  if (params.accountIds.includes("default")) return _accountIdJ7GeQlaZ.t;
...
function resolveMergedAccountConfig(params) {
  const accountConfig = params.normalizeAccountId ? (0, _accountLookupZCs8AOJr.n)(params.accounts, params.accountId, params.normalizeAccountId) : (0, _accountLookupZCs8AOJr.t)(params.accounts, params.accountId);
...
function describeAccountSnapshot(params) {
  return {
    ...
    name: (0, _stringCoerceBUSzWgUA.s)(params.account.name),
