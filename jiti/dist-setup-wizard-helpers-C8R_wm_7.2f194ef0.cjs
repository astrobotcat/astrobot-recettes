"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.A = promptLegacyChannelAllowFromForAccount;exports.B = runSingleChannelSecretStep;exports.C = parseSetupEntriesAllowingWildcard;exports.D = patchTopLevelChannelConfigSection;exports.E = patchNestedChannelConfigSection;exports.F = resolveAccountIdForConfigure;exports.G = void 0;exports.H = setAccountDmAllowFromForChannel;exports.I = resolveEntriesWithOptionalToken;exports.J = setSetupChannelEnabled;exports.K = setNestedChannelAllowFrom;exports.L = resolveGroupAllowlistWithLookupNotes;exports.M = promptParsedAllowFromForScopedChannel;exports.N = promptResolvedAllowFrom;exports.O = void 0;exports.P = promptSingleChannelSecretInput;exports.Q = splitSetupEntries;exports.R = resolveParsedAllowFromEntries;exports.S = parseMentionOrPrefixedId;exports.T = patchChannelConfigForAccount;exports.U = setAccountGroupPolicyForChannel;exports.V = setAccountAllowFromForChannel;exports.W = setChannelDmPolicyWithAllowFrom;exports.X = setTopLevelChannelDmPolicyWithAllowFrom;exports.Y = setTopLevelChannelAllowFrom;exports.Z = setTopLevelChannelGroupPolicy;exports._ = createTopLevelChannelParsedAllowFromPrompt;exports.a = createAllowFromSection;exports.b = noteChannelLookupFailure;exports.c = createNestedChannelDmPolicy;exports.d = createPromptParsedAllowFromForAccount;exports.f = createStandardChannelSetupStatus;exports.g = createTopLevelChannelGroupPolicySetter;exports.h = createTopLevelChannelDmPolicySetter;exports.i = createAccountScopedGroupAccessSection;exports.j = promptParsedAllowFromForAccount;exports.k = promptLegacyChannelAllowFrom;exports.l = createNestedChannelDmPolicySetter;exports.m = createTopLevelChannelDmPolicy;exports.n = buildSingleChannelSecretPromptState;exports.o = void 0;exports.p = createTopLevelChannelAllowFromSetter;exports.q = setNestedChannelDmPolicyWithAllowFrom;exports.r = createAccountScopedAllowFromSection;exports.s = createNestedChannelAllowFromSetter;exports.t = addWildcardAllowFrom;exports.u = createNestedChannelParsedAllowFromPrompt;exports.v = mergeAllowFromEntries;exports.w = parseSetupEntriesWithParser;exports.x = noteChannelLookupSummary;exports.y = normalizeAllowFromEntries;exports.z = resolveSetupAccountId;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
var _setupHelpersNxWLbAbV = require("./setup-helpers-NxWLbAbV.js");
var _providerAuthModeB3mgHAFL = require("./provider-auth-mode-b3mgHAFL.js");function _interopRequireWildcard(e, t) {if ("function" == typeof WeakMap) var r = new WeakMap(),n = new WeakMap();return (_interopRequireWildcard = function (e, t) {if (!t && e && e.__esModule) return e;var o,i,f = { __proto__: null, default: e };if (null === e || "object" != typeof e && "function" != typeof e) return f;if (o = t ? n : r) {if (o.has(e)) return o.get(e);o.set(e, f);}for (const t in e) "default" !== t && {}.hasOwnProperty.call(e, t) && ((i = (o = Object.defineProperty) && Object.getOwnPropertyDescriptor(e, t)) && (i.get || i.set) ? o(f, t, i) : f[t] = e[t]);return f;})(e, t);}
//#region src/channels/plugins/setup-wizard-helpers.ts
let providerAuthInputPromise;
function loadProviderAuthInput() {
  providerAuthInputPromise ??= Promise.resolve().then(() => jitiImport("./provider-auth-ref-cUR2reG-.js").then((m) => _interopRequireWildcard(m)));
...
const promptAccountId = async (params) => {
  ...
  if (choice !== "__new__") return (0, _accountIdJ7GeQlaZ.n)(choice);
  const entered = await params.prompter.text({
    message: `New ${params.label} account id`,
    validate: (value) => (0, _stringCoerceBUSzWgUA.s)(value) ? void 0 : "Required"
  });
  const normalized = (0, _accountIdJ7GeQlaZ.n)(entered);
  if (((0, _stringCoerceBUSzWgUA.s)(entered) ?? "") !== normalized) await params.prompter.note(`Normalized account id to "${normalized}".`, `${params.label} account`);
  return normalized;
};exports.O = promptAccountId;
function addWildcardAllowFrom(allowFrom) {
  const next = (0, _stringNormalizationXm3f27dv.s)(allowFrom ?? []);
  if (!next.includes("*")) next.push("*");
  return next;
}
function mergeAllowFromEntries(current, additions) {
  const merged = (0, _stringNormalizationXm3f27dv.s)([...(current ?? []), ...additions]);
...
function normalizeAllowFromEntries(entries, normalizeEntry) {
  const normalized = (0, _stringNormalizationXm3f27dv.s)(entries).map((entry) => {
    if (entry === "*") return "*";
    if (!normalizeEntry) return entry;
    return (0, _stringCoerceBUSzWgUA.s)(normalizeEntry(entry)) ?? "";
  }).filter(Boolean);
...
function resolveSetupAccountId(params) {
  return params.accountId?.trim() ? (0, _accountIdJ7GeQlaZ.n)(params.accountId) : params.defaultAccountId;
}
async function resolveAccountIdForConfigure(params) {
  const override = params.accountOverride?.trim();
  let accountId = override ? (0, _accountIdJ7GeQlaZ.n)(override) : params.defaultAccountId;
...
function patchConfigForScopedAccount(params) {
  ...
  return (0, _setupHelpersNxWLbAbV.l)({
    cfg: accountId === "default" || hasExistingAccounts ? cfg : (0, _setupHelpersNxWLbAbV.c)({
      cfg,
      channelKey: channel
    }),
    channelKey: channel,
...
async function runSingleChannelSecretStep(params) {
  ...
  if (result.action === "use-env") return {
    ...
    resolvedValue: (0, _stringCoerceBUSzWgUA.s)(params.envValue)
  };
...
async function promptSingleChannelSecretInput(params) {
  if ((await (0, _providerAuthModeB3mgHAFL.t)({
    prompter: params.prompter,
...
const setLegacyChannelDmPolicyWithAllowFrom = exports.G = setCompatChannelDmPolicyWithAllowFrom;
const createLegacyCompatChannelDmPolicy = exports.o = createCompatChannelDmPolicy;
//#endregion /* v9-956648ccd0aa5441 */
