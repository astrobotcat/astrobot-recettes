...
// Provider Registry
// ============================================================================
const BUILT_IN_OAUTH_PROVIDERS = [_anthropic.anthropicOAuthProvider, _githubCopilot.githubCopilotOAuthProvider, _googleGeminiCli.geminiCliOAuthProvider, _googleAntigravity.antigravityOAuthProvider, _openaiCodex.openaiCodexOAuthProvider];const oauthProviderRegistry = new Map(BUILT_IN_OAUTH_PROVIDERS.map((provider) => [provider.id, provider])); /**
