"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = resolveDmGroupAccessWithCommandGate;exports.c = resolvePinnedMainDmOwnerFromAllowlist;exports.i = resolveDmGroupAccessDecision;exports.n = readStoreAllowFromForDmPolicy;exports.o = resolveDmGroupAccessWithLists;exports.r = resolveDmAllowState;exports.s = resolveEffectiveAllowFromLists;exports.t = void 0;var _stringNormalizationXm3f27dv = require("./string-normalization-xm3f27dv.js");
var _commandGatingBJZZvAwg = require("./command-gating-BJZZvAwg.js");
var _pairingStoreC_d7unmE = require("./pairing-store-C_d7unmE.js");
var _allowFromC32y1iZ = require("./allow-from-C32y1iZ3.js");
var _groupAccessCH5DRjVf = require("./group-access-CH5DRjVf.js");
...
function resolveEffectiveAllowFromLists(params) {
  ...
  return {
    effectiveAllowFrom: (0, _stringNormalizationXm3f27dv.s)((0, _allowFromC32y1iZ.r)({
      allowFrom,
      storeAllowFrom: Array.isArray(params.storeAllowFrom) ? params.storeAllowFrom : void 0,
      dmPolicy: params.dmPolicy ?? void 0
    })),
    effectiveGroupAllowFrom: (0, _stringNormalizationXm3f27dv.s)((0, _allowFromC32y1iZ.i)({
      allowFrom,
      groupAllowFrom,
...
async function readStoreAllowFromForDmPolicy(params) {
  ...
  return await (params.readStore ?? ((provider, accountId) => (0, _pairingStoreC_d7unmE.a)(provider, process.env, accountId)))(params.provider, params.accountId).catch(() => []);
}
function resolveDmGroupAccessDecision(params) {
  ...
  const effectiveAllowFrom = (0, _stringNormalizationXm3f27dv.s)(params.effectiveAllowFrom);
  const effectiveGroupAllowFrom = (0, _stringNormalizationXm3f27dv.s)(params.effectiveGroupAllowFrom);
  if (params.isGroup) {
    const groupAccess = (0, _groupAccessCH5DRjVf.n)({
      groupPolicy,
...
function resolveDmGroupAccessWithCommandGate(params) {
  ...
  const configuredAllowFrom = (0, _stringNormalizationXm3f27dv.s)(params.allowFrom ?? []);
  const configuredGroupAllowFrom = (0, _stringNormalizationXm3f27dv.s)((0, _allowFromC32y1iZ.i)({
    allowFrom: configuredAllowFrom,
    groupAllowFrom: (0, _stringNormalizationXm3f27dv.s)(params.groupAllowFrom ?? []),
    fallbackToAllowFrom: params.groupAllowFromFallbackToAllowFrom ?? void 0
  }));
  ...
  const commandGate = params.command ? (0, _commandGatingBJZZvAwg.n)({
...
async function resolveDmAllowState(params) {
  const configAllowFrom = (0, _stringNormalizationXm3f27dv.s)(Array.isArray(params.allowFrom) ? params.allowFrom : void 0);
