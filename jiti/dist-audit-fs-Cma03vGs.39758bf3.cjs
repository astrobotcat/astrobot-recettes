"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = createIcaclsResetCommand;exports.i = safeStat;exports.n = formatPermissionRemediation;exports.o = formatIcaclsResetCommand;exports.r = inspectPathPermissions;exports.t = formatPermissionDetail;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
const normalize = (value) => (0, _stringCoerceBUSzWgUA.i)(value);
...
async function inspectWindowsAcl(targetPath, opts) {
  const exec = opts?.exec ?? _execBAdwyfxI.i;
  try {
