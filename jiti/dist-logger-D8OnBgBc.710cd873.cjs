...
function normalizeRuntimeBasename(execPath) {
  ...
  return (0, _stringCoerceBUSzWgUA.i)(lastSlash === -1 ? trimmed : trimmed.slice(lastSlash + 1));
}
...
const requireConfig$1 = (0, _nodeRequireDvwmVoHm.t)("file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/dist/logger-D8OnBgBc.js");
...
function resolveEnvLogLevelOverride() {
  const trimmed = (0, _stringCoerceBUSzWgUA.s)(process.env.OPENCLAW_LOG_LEVEL) ?? "";
  if (!trimmed) {
...
function resolveDefaultLogDir() {
  return canUseNodeFs() ? (0, _tmpOpenclawDirEyAoWbVe.n)() : _tmpOpenclawDirEyAoWbVe.t;
}
function resolveDefaultLogFile(defaultLogDir) {
  return canUseNodeFs() ? _nodePath.default.join(defaultLogDir, "openclaw.log") : `${_tmpOpenclawDirEyAoWbVe.t}/openclaw.log`;
}
...
const requireConfig = (0, _nodeRequireDvwmVoHm.t)("file:///home/linuxbrew/.linuxbrew/lib/node_modules/openclaw/dist/logger-D8OnBgBc.js");
