"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.a = toInternalMessageSentContext;exports.c = toPluginInboundClaimEvent;exports.d = toPluginMessageSentEvent;exports.f = fireAndForgetHook;exports.i = toInternalMessageReceivedContext;exports.l = toPluginMessageContext;exports.n = deriveInboundMessageHookContext;exports.o = toInternalMessageTranscribedContext;exports.r = toInternalMessagePreprocessedContext;exports.s = toPluginInboundClaimContext;exports.t = buildCanonicalSentMessageHookContext;exports.u = toPluginMessageReceivedEvent;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
function fireAndForgetHook(task, label, logger = _globalsDe6QTwLG.r) {
  task.catch((err) => {
...
function deriveInboundMessageHookContext(ctx, overrides) {
  ...
  const channelId = (0, _stringCoerceBUSzWgUA.i)(ctx.OriginatingChannel ?? ctx.Surface ?? ctx.Provider ?? "");
...
function resolveInboundConversation(canonical) {
  const channelId = (0, _registryDelpa74L.i)(canonical.channelId);
  const pluginResolved = channelId ? (0, _registryDelpa74L.t)(channelId)?.messaging?.resolveInboundConversation?.({
    from: canonical.from,
  ...
  if (pluginResolved) return {
    conversationId: (0, _stringCoerceBUSzWgUA.s)(pluginResolved.conversationId),
    parentConversationId: (0, _stringCoerceBUSzWgUA.s)(pluginResolved.parentConversationId)
  };
