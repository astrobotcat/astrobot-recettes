"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.t = exports.r = exports.n = void 0;var _formatDkmJkZf = require("./format-DkmJkZf4.js");
var _configRuntime = require("openclaw/plugin-sdk/config-runtime");
var _groupAccess = require("openclaw/plugin-sdk/group-access");
...
const evaluateTelegramGroupBaseAccess = (params) => {
  ...
  return { allowed: true };
};exports.t = evaluateTelegramGroupBaseAccess;
const resolveTelegramRuntimeGroupPolicy = (params) => (0, _configRuntime.resolveOpenProviderRuntimeGroupPolicy)({
  providerConfigPresent: params.providerConfigPresent,
  groupPolicy: params.groupPolicy,
  defaultGroupPolicy: params.defaultGroupPolicy
});exports.r = resolveTelegramRuntimeGroupPolicy;
const evaluateTelegramGroupPolicyAccess = (params) => {
  ...
  const fallbackPolicy = (0, _formatDkmJkZf.V)(params.telegramCfg.groupPolicy, params.cfg.channels?.defaults?.groupPolicy) ?? runtimeFallbackPolicy;
  const groupPolicy = params.useTopicAndGroupOverrides ? (0, _formatDkmJkZf.V)(params.topicConfig?.groupPolicy, params.groupConfig?.groupPolicy, params.telegramCfg.groupPolicy, params.cfg.channels?.defaults?.groupPolicy) ?? runtimeFallbackPolicy : fallbackPolicy;
  ...
  if (groupPolicy === "allowlist" && params.enforceAllowlistAuthorization) {
    const senderId = params.senderId ?? "";
    const senderAuthorization = (0, _groupAccess.evaluateMatchedGroupAccessForPolicy)({
      groupPolicy,
      ...
      allowlistMatched: chatExplicitlyAllowed && !params.effectiveGroupAllow.hasEntries || (0, _formatDkmJkZf.H)({
        allow: params.effectiveGroupAllow,
        senderId,
        senderUsername: params.senderUsername ?? ""
      })
...
//#endregion
exports.n = evaluateTelegramGroupPolicyAccess; /* v9-444d199a908b7239 */
