"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports._ = resolveOptionalConfigString;exports.a = createHybridChannelConfigAdapter;exports.b = formatConfigWriteDeniedMessageShared;exports.c = createScopedChannelConfigAdapter;exports.d = createTopLevelChannelConfigAdapter;exports.f = createTopLevelChannelConfigBase;exports.g = resolveChannelConfigWrites;exports.h = mapAllowFromEntries;exports.i = canBypassConfigWritePolicy;exports.l = createScopedChannelConfigBase;exports.m = formatTrimmedAllowFromEntries;exports.n = authorizeConfigWrite;exports.o = createHybridChannelConfigBase;exports.p = formatConfigWriteDeniedMessage;exports.r = buildAccountScopedDmSecurityPolicy;exports.s = createScopedAccountConfigAccessors;exports.t = adaptScopedAccountAccessor;exports.u = createScopedDmSecurityResolver;exports.v = authorizeConfigWriteShared;exports.x = resolveConfigWriteTargetFromPathShared;exports.y = canBypassConfigWritePolicyShared;var _stringCoerceBUSzWgUA = require("./string-coerce-BUSzWgUA.js");
...
var _configHelpersBnrSrKhR = require("./config-helpers-BnrSrKhR.js");
...
function resolveChannelAccountConfig(channelConfig, accountId) {
  return (0, _accountLookupZCs8AOJr.t)(channelConfig.accounts, (0, _accountIdJ7GeQlaZ.n)(accountId));
}
...
function authorizeConfigWriteShared(params) {
  ...
  for (const target of listConfigWriteTargetScopes(params.target)) {
    ...
    const key = `${target.channelId}:${(0, _accountIdJ7GeQlaZ.n)(target.accountId)}`;
...
function resolveExplicitConfigWriteTargetShared(scope) {
  ...
  const accountId = (0, _accountIdJ7GeQlaZ.n)(scope.accountId);
...
function resolveConfigWriteTargetFromPathShared(params) {
  ...
  return resolveExplicitConfigWriteTargetShared({
    channelId,
    accountId: (0, _accountIdJ7GeQlaZ.n)(params.path[3])
  });
}
...
function canBypassConfigWritePolicy(params) {
  return canBypassConfigWritePolicyShared({
    ...params,
    isInternalMessageChannel: (channel) => (0, _stringCoerceBUSzWgUA.o)(channel) === INTERNAL_MESSAGE_CHANNEL
  });
}
...
function createScopedChannelConfigBase(params) {
  return createNamedAccountConfigBase({
    ...
    setAccountEnabled({ cfg, accountId, enabled }) {
      return (0, _configHelpersBnrSrKhR.r)({
        cfg,
    ...
    deleteAccount({ cfg, accountId }) {
      return (0, _configHelpersBnrSrKhR.n)({
        cfg,
        sectionKey: params.sectionKey,
        accountId,
...
function createHybridChannelConfigBase(params) {
  return createNamedAccountConfigBase({
    ...
    defaultAccountId: params.defaultAccountId,
    setAccountEnabled({ cfg, accountId, enabled }) {
      if ((0, _accountIdJ7GeQlaZ.n)(accountId) === "default") return setTopLevelChannelEnabledInConfigSection({
        cfg,
        sectionKey: params.sectionKey,
        enabled
      });
    ...
    deleteAccount({ cfg, accountId }) {
      if ((0, _accountIdJ7GeQlaZ.n)(accountId) === "default") {
