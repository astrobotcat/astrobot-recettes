...
class AssistantMessageComponent extends _piTui.Container {
  ...
  hiddenThinkingLabel;
  lastMessage;
  constructor(message, hideThinkingBlock = false, markdownTheme = (0, _theme.getMarkdownTheme)(), hiddenThinkingLabel = "Thinking...") {
    super();
    ...
    for (let i = 0; i < message.content.length; i++) {
      ...
      if (content.type === "thinking" && content.thinking.trim()) {
        ...
        if (this.hideThinkingBlock) {
          ...
          this.contentContainer.addChild(new _piTui.Text(_theme.theme.italic(_theme.theme.fg("thinkingText", this.hiddenThinkingLabel)), 1, 0));
...
}exports.AssistantMessageComponent = AssistantMessageComponent; /* v9-3214f5d1c5b8afec */
