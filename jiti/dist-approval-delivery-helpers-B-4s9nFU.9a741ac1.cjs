"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.i = splitChannelApprovalCapability;exports.n = createApproverRestrictedNativeApprovalCapability;exports.r = createChannelApprovalCapability;exports.t = createApproverRestrictedNativeApprovalAdapter;var _messageChannelCBqCPFa_ = require("./message-channel-CBqCPFa_.js");
  ...
  return createChannelApprovalCapability({
    ...
    delivery: {
      ...
      shouldSuppressForwardingFallback: (input) => {
        if (((0, _messageChannelCBqCPFa_.u)(input.target.channel) ?? input.target.channel) !== params.channel) return false;
        if (params.requireMatchingTurnSourceChannel) {
          if ((0, _messageChannelCBqCPFa_.u)(input.request.request.turnSourceChannel) !== params.channel) return false;
        }
