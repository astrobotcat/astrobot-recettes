 ...
 */const Ajv = _ajv.default.default || _ajv.default;const ajv = new Ajv();
...
const ReasoningEffortMapSchema = _typebox.Type.Object({
  minimal: _typebox.Type.Optional(_typebox.Type.String()),
  low: _typebox.Type.Optional(_typebox.Type.String()),
  medium: _typebox.Type.Optional(_typebox.Type.String()),
  high: _typebox.Type.Optional(_typebox.Type.String()),
  xhigh: _typebox.Type.Optional(_typebox.Type.String())
});
const OpenAICompletionsCompatSchema = _typebox.Type.Object({
  ...
  reasoningEffortMap: _typebox.Type.Optional(ReasoningEffortMapSchema),
...
}exports.ModelRegistry = ModelRegistry; /* v9-ccd6818d001bc72e */
